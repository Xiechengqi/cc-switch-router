...
export const messages = {
  en: {
    ...
    "settings.pendingRestartSecretChanged": "The saved secret differs from the running process.",
    ...
    "settings.effectiveSecretSet": "A secret is active in the running Router.",
    "settings.effectiveSecretUnset": "No secret is active in the running Router.",
    ...
    "settings.secretKeepPlaceholder": "Leave blank to keep the current secret",
  ...
  "zh-CN": {
    ...
    "settings.pendingRestartSecretChanged": "已保存的密钥与当前进程中的密钥不同。",
    ...
    "settings.effectiveSecretSet": "当前 Router 进程中已有生效的密钥。",
    "settings.effectiveSecretUnset": "当前 Router 进程中没有生效的密钥。",
    ...
    "settings.secretKeepPlaceholder": "留空以保留当前密钥",
