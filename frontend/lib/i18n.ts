...
export const messages = {
  en: {
    ...
    "account.pageHint": "Manage account settings for Host Provider operations.",
    ...
    "account.blockedHint": "A Provider cleanup marked as unpaid blocks that account only from your Hosts. You can restore access here.",
    ...
    "nav.rentalsTab": "Rentals",
    "clientMarket.tabMyHosts": "My hosts",
    "clientMarket.tabMyRentals": "My rentals",
  ...
  "zh-CN": {
    ...
    "nav.login": "登录",
    "account.title": "账户",
    "account.pageHint": "管理 Host Provider 相关的账户设置。",
    ...
    "account.blockedHint": "Provider 以未付款原因清理后，只会禁止该账号使用你的 Host。你可以在此恢复其权限。",
    ...
    "clientMarket.tabMyRentals": "我的租用",
