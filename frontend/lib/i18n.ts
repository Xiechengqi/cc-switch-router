...
export const messages = {
  en: {
    ...
    "serverLogs.scopeAria": "Log visibility scope",
    "serverLogs.lastFiveMinutes": "Last 5 minutes",
    "serverLogs.retentionDays": "{days}-day retention",
    "serverLogs.export": "Export logs",
    "serverLogs.search": "Search target or message",
    "serverLogs.allLevels": "All levels",
    "serverLogs.allClients": "All Clients",
    "serverLogs.time": "Received",
    "serverLogs.client": "Client",
    "serverLogs.level": "Level",
    "serverLogs.target": "Target",
    "serverLogs.message": "Message",
    "serverLogs.details": "Details",
    "serverLogs.clientDetails": "Client Details",
    "serverLogs.noSubdomain": "No Subdomain",
    "serverLogs.visibleActivity": "Visible Activity",
    "serverLogs.visibleEvents": "Visible events",
    "serverLogs.latestEvent": "Latest event",
    "serverLogs.earliestEvent": "Earliest event",
    "serverLogs.empty": "No logs match the current view.",
    "serverLogs.loadOlder": "Load older",
    "serverLogs.publicDisabled": "Public log access is disabled.",
  ...
  "zh-CN": {
    ...
    "serverLogs.search": "搜索 target 或消息",
    "serverLogs.allLevels": "全部级别",
    "serverLogs.allClients": "全部 Client",
    "serverLogs.time": "接收时间",
    "serverLogs.client": "Client",
    "serverLogs.level": "级别",
    "serverLogs.target": "Target",
    "serverLogs.message": "消息",
    "serverLogs.details": "详情",
    "serverLogs.clientDetails": "Client 详情",
    "serverLogs.noSubdomain": "未配置 Subdomain",
    "serverLogs.visibleActivity": "当前可见活动",
    "serverLogs.visibleEvents": "可见日志",
    "serverLogs.latestEvent": "最近日志",
    "serverLogs.earliestEvent": "最早日志",
    "serverLogs.empty": "当前视图没有匹配的日志。",
    "serverLogs.loadOlder": "加载更早日志",
    "serverLogs.publicDisabled": "公共日志访问已关闭。",
