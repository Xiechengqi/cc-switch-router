...
export const messages = {
  en: {
    ...
    "shareMarket.error.currency": "Currency must be a three-letter code.",
    ...
    "clientMarket.rentalPrice": "Rental price (USD)",
    "clientMarket.rentalPeriod": "Rental period (days)",
    "clientMarket.priceUsd": "Price (USD)",
  ...
  "zh-CN": {
    ...
    "shareMarket.error.currency": "币种必须是三个英文字母。",
    ...
    "clientMarket.rentalPrice": "租赁价格（美元）",
    "clientMarket.rentalPeriod": "租赁周期（天）",
    "clientMarket.priceUsd": "价格（美元）",
