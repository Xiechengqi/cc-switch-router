...
export const messages = {
  en: {
    ...
    "clientMarket.importSizeLimit": "Host import must not exceed 1 MB.",
    "clientMarket.importVersionRequired": "Select a version 1 Client Market Host export file.",
  ...
  "zh-CN": {
    ...
    "clientMarket.importSizeLimit": "Host 导入文件不能超过 1 MB。",
    "clientMarket.importVersionRequired": "请选择版本为 1 的 Client Market Host 导出文件。",
