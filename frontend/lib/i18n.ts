...
export const messages = {
  en: {
    ...
    "account.consumerUsage.embed": "Embed Markdown",
    "account.consumerUsage.embedHint": "Copy this into a README when public stats are enabled.",
  ...
  "zh-CN": {
    ...
    "account.consumerUsage.embed": "嵌入 Markdown",
    "account.consumerUsage.embedHint": "公开统计开启后，可复制到 README。",
