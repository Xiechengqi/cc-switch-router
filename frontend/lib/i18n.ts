...
export const messages = {
  en: {
    ...
    "shareMarket.release": "Return seat",
    ...
    "account.visibilityHint": "Payment methods are shown to renters. Contact info also appears in payment dialogs and via the Market contact icon.",
  ...
  "zh-CN": {
    ...
    "account.visibilityHint": "收款方式对租户可见；联系信息会在付款弹窗与 Market 联系图标中展示。",
