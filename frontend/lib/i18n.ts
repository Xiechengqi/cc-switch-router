...
export const messages = {
  en: {
    ...
    "dashboard.hint.modelPricing": "Share-level default pricing. Provider percentages take priority when configured. Leave blank to use the market default; range 1-100.",
  ...
  "zh-CN": {
    ...
    "dashboard.hint.modelPricing": "Share 级默认定价；供应商配置了百分比时优先使用供应商值。留空则使用 market 默认定价；范围 1-100。",
