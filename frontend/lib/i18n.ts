...
export const messages = {
  en: {
    ...
    "clientMarket.cleanupFailed": "Cleanup failed. The host remains unavailable until it is verified.",
    ...
    "clientMarket.statusHint.draining": "Client cleanup in progress; not allocatable yet.",
    "clientMarket.statusHint.disabled": "Manually taken out of the pool (rarely set by current UI).",
    "clientMarket.statusHint.unreachable": "SSH/network or rollback failed; needs operator reverify.",
  ...
  "zh-CN": {
    ...
    "clientMarket.cleanupFailed": "清理失败，主机在重新验证前不会回到空闲池。",
    ...
    "clientMarket.statusHint.draining": "正在清理 Client，暂不可再分配。",
    "clientMarket.statusHint.disabled": "已移出分配池（当前界面很少主动设置）。",
    "clientMarket.statusHint.unreachable": "SSH/网络失败或回滚未完成，需人工复检。",
