...
export const messages = {
  en: {
    ...
    "marketApproval.closedDescription": "{owner} has closed this postpaid relationship. Contact the owner if you need access restored.",
    ...
    "marketAccess.blacklistBanner": "At least one free or paid market scope allows users by default unless you explicitly deny them. Paid blacklist scopes also use the public limited credit below. Keep only the scopes whose exposure you accept.",
  ...
  "zh-CN": {
    ...
    "marketApproval.closedDescription": "{owner} 已关闭与你的后付费关系。如需恢复使用，请联系 Owner。",
    ...
    "marketAccess.blacklistBanner": "至少一个免费或付费市场作用域会默认允许未被明确拒绝的用户使用；付费黑名单作用域还会使用下方公共有限额度。请只保留你愿意承担风险的作用域。",
