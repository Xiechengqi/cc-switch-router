...
export const messages = {
  en: {
    ...
    "account.loading": "Loading payment settings...",
    ...
    "createClient.officialUnavailable": "The official Provider has no registered Host capacity. Select another Provider explicitly only if you trust it.",
  ...
  "zh-CN": {
    ...
    "createClient.routerOwner": "Router owner",
    "createClient.officialUnavailable": "官方 Provider 当前没有已登记的 Host 容量。只有在你明确信任其他 Provider 时才选择它。",
