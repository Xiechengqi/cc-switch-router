...
export const messages = {
  en: {
    ...
    "dashboard.sharePriorityHint": "Default token-market scheduling view. Specific requests may still change order by model, API key scope, sticky routing, cooldowns, and market runtime state.",
  ...
  "zh-CN": {
    ...
    "dashboard.sharePriorityHint": "Token market 默认调度视图。具体请求仍可能受模型、API key scope、sticky 路由、冷却和 market 运行状态影响而改变顺序。",
