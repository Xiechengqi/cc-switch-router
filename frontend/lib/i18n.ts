...
export const messages = {
  en: {
    ...
    "createClient.officialUnavailable": "The official Provider has no idle Host capacity right now. Open Host Provider and include another owner only if you trust it.",
  ...
  "zh-CN": {
    ...
    "createClient.routerOwner": "Router owner",
    "createClient.officialUnavailable": "官方 Provider 当前没有空闲 Host。只有在你明确信任其他 Provider 时，再打开 Host Provider 勾选。",
