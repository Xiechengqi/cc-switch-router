...
export const messages = {
  en: {
    ...
    "clientMarket.nextBillCountdown": "Next bill in {countdown}",
    "clientMarket.paymentDueCountdown": "Payment due in {countdown}",
  ...
  "zh-CN": {
    ...
    "clientMarket.nextBillCountdown": "下次账单 {countdown}",
    "clientMarket.paymentDueCountdown": "待付款 {countdown}",
