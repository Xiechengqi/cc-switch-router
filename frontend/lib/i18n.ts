...
export const messages = {
  en: {
    ...
    "nav.logout": "Logout",
    "nav.login": "Login",
    "serverLogs.title": "Logs",
    "serverLogs.filterClients": "Filter Clients",
    "serverLogs.client": "Client",
    "serverLogs.access": "Log access",
    "serverLogs.routerOwner": "Router owner",
    "serverLogs.clientOwner": "Client owner",
    "serverLogs.publicAccess": "Public",
    "serverLogs.visibleLines": "{count} lines",
    "serverLogs.retainedLines": "Latest {count} lines / Client",
    "serverLogs.noSubdomain": "No Subdomain",
    "serverLogs.emptyClients": "No Clients match the current filter.",
    "serverLogs.noLogs": "No logs.",
    "serverLogs.refreshClient": "Refresh Client logs",
    "serverLogs.logText": "Read-only Client logs",
    "serverLogs.collectionDisabled": "Server log collection is disabled.",
  ...
  "zh-CN": {
    ...
    "nav.login": "登录",
    "serverLogs.title": "日志",
    "serverLogs.filterClients": "筛选 Client",
    "serverLogs.client": "Client",
    "serverLogs.access": "日志权限",
    "serverLogs.routerOwner": "Router owner",
    "serverLogs.clientOwner": "Client owner",
    "serverLogs.publicAccess": "公开",
    "serverLogs.visibleLines": "{count} 行",
    "serverLogs.retainedLines": "每个 Client 最近 {count} 行",
    "serverLogs.noSubdomain": "未配置 Subdomain",
    "serverLogs.emptyClients": "没有符合筛选条件的 Client。",
    "serverLogs.noLogs": "暂无日志。",
    "serverLogs.refreshClient": "刷新 Client 日志",
    "serverLogs.logText": "只读 Client 日志",
    "serverLogs.collectionDisabled": "Server 日志采集已关闭。",
