...
export const messages = {
  en: {
    ...
    "dashboard.confirmFreeDesc": "Free shares are exposed to all markets for free and no longer generate revenue. Confirm the switch.",
  ...
  "zh-CN": {
    ...
    "dashboard.confirmFreeDesc": "Free share 会向所有市场免费曝光，且不再产生收益。请确认切换。",
