...
export const messages = {
  en: {
    ...
    "shareMarket.catalog.subtitle":
      "Compare available seats by provider, supported apps, terms, and service quality.",
    ...
    "shareMarket.catalog.search": "Search provider, app, model, Share, or owner",
    "shareMarket.catalog.familyFilter": "Filter by provider type",
    "shareMarket.catalog.myRentals": "My rentals ({count})",
    "shareMarket.catalog.empty": "No available Share seats match these filters.",
  ...
  "zh-CN": {
    ...
    "shareMarket.catalog.subtitle":
      "按供应商、支持的 App、使用条款和服务质量比较可租用拼车位。",
    ...
    "shareMarket.catalog.search": "搜索供应商、App、模型、Share 或车主",
    "shareMarket.catalog.familyFilter": "按供应商类型筛选",
    "shareMarket.catalog.myRentals": "我的租用（{count}）",
    "shareMarket.catalog.empty": "没有符合当前筛选条件的可租用拼车位。",
