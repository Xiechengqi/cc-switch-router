...
export const messages = {
  en: {
    ...
    "clientMarket.terminal.autoMinimized": "Open terminals were minimized while leaving Client Market.",
  ...
  "zh-CN": {
    ...
    "clientMarket.terminal.autoMinimized": "离开 Client 市场时已自动最小化打开的终端。",
