...
export const messages = {
  en: {
    ...
    "shareMarket.integrity.reason.requiredAppDisabled": "The rented App API was disabled",
    ...
    "shareMarket.integrity.reason.bindingMissing": "The rented App has no provider binding",
    ...
    "shareMarket.integrity.reason.requiredAppUnavailable": "The rented App API is unavailable",
    "shareMarket.integrity.reason.appScopeNotEnforced": "The single-App access scope was not enforced",
    ...
    "shareMarket.error.modelUnavailable": "The selected App or model is currently unavailable.",
    "shareMarket.error.contractIncompatible": "The Share configuration no longer matches an active rental contract.",
    "shareMarket.error.requiredAppUnavailable": "The selected App is not enabled and available on this Share.",
  ...
  "zh-CN": {
    ...
    "shareMarket.integrity.reason.requiredAppDisabled": "租用的 App API 已被停用",
    ...
    "shareMarket.integrity.reason.bindingMissing": "租用的 App 缺少供应商绑定",
    ...
    "shareMarket.integrity.reason.requiredAppUnavailable": "租用的 App API 当前不可用",
    "shareMarket.integrity.reason.appScopeNotEnforced": "单 App 访问范围尚未生效",
    ...
    "shareMarket.error.modelUnavailable": "所选 App 或模型当前不可用。",
    "shareMarket.error.contractIncompatible": "Share 当前配置与生效中的租用合同不一致。",
    "shareMarket.error.requiredAppUnavailable": "该 Share 未启用并提供所选 App。",
