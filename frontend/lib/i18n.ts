...
export const messages = {
  en: {
    ...
    "account.notifications.channelHint":
      "Enable one or more channels. Registration messages always stay on email because they carry the Client web password hint.",
    ...
    "account.notifications.channel.telegramHint": "Receive an additional copy in the bound private chat.",
    "account.notifications.channel.both": "Both",
    "account.notifications.channel.bothHint": "Send one copy to each.",
  ...
  "zh-CN": {
    ...
    "account.notifications.channelHint":
      "至少启用一个渠道。注册消息始终走邮件，因为其中包含 Client Web 密码提示。",
    "account.notifications.channel.email": "邮件",
    "account.notifications.channel.emailHint": "在账号邮箱接收通知。",
    "account.notifications.channel.telegram": "Telegram",
    "account.notifications.channel.telegramHint": "在已绑定的私聊中额外接收一份通知。",
    "account.notifications.channel.both": "两者",
    "account.notifications.channel.bothHint": "两边各发一份。",
