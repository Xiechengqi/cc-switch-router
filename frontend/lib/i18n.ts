...
export const messages = {
  en: {
    ...
    "nav.logout": "Logout",
    "nav.login": "Login",
    "clientLogs.button": "Logs",
    "clientLogs.title": "Client logs",
    "clientLogs.refresh": "Refresh logs",
    "clientLogs.pauseAutoRefresh": "Pause auto refresh",
    "clientLogs.resumeAutoRefresh": "Resume auto refresh",
    "clientLogs.logText": "Read-only Client logs",
    "clientLogs.loading": "Loading logs...",
    "clientLogs.empty": "No logs.",
    "clientLogs.error.loginRequired": "Sign in to view Server process logs.",
    "clientLogs.error.forbidden": "Only the Router administrator or this Client owner can view process logs.",
    "clientLogs.error.disabled": "INFO log collection is disabled on this Server.",
    "clientLogs.error.busy": "Client logs are busy. Retrying shortly.",
    "clientLogs.error.offline": "The Client is offline or reconnecting. Process logs are temporarily unavailable.",
    ...
    "shareMarket.catalog.familyIdleHint": "{family}: {count} idle seats",
    "shareMarket.catalog.mine": "Mine",
    "shareMarket.catalog.mineHint": "Show only Shares you are renting",
    "shareMarket.catalog.mineSeat": "Mine",
    "shareMarket.catalog.mineEmpty": "You are not renting a seat in any matching Share.",
    "shareMarket.catalog.previousPage": "Previous",
    "shareMarket.catalog.nextPage": "Next",
    "shareMarket.catalog.page": "Page {page} / {pages}",
    "shareMarket.catalog.myRentals": "My rentals ({count})",
    "shareMarket.catalog.empty": "No Shares match this search.",
    "shareMarket.catalog.availabilityFilter": "Filter by idle seats",
    "shareMarket.catalog.availability.all": "All Shares",
    "shareMarket.catalog.availability.idle": "Idle seats only",
    ...
    "shareMarket.catalog.providerUnknown": "Provider details unavailable",
    "shareMarket.catalog.terms": "Seat terms",
    "shareMarket.catalog.serviceTerm": "Service term",
    "shareMarket.catalog.billingStart": "Billing starts",
    "shareMarket.catalog.afterTrial": "After {hours}h free service",
    "shareMarket.catalog.serviceQuality": "Service quality",
    "shareMarket.catalog.samples": "Recent requests",
    "shareMarket.catalog.observedMinutes": "Observed minutes",
    "shareMarket.catalog.seller": "Seller",
    "shareMarket.catalog.otherSeats": "Other seats in this Share",
    "shareMarket.catalog.idleSeats": "{count} idle",
    "shareMarket.catalog.occupancy": "{idle}/{total} idle",
    "shareMarket.catalog.full": "No idle seats",
    "shareMarket.catalog.seatsAndRiders": "Seats and riders",
    "shareMarket.catalog.shareSeats": "Share seats",
    "shareMarket.catalog.anonymousRider": "Rider",
    "shareMarket.catalog.noRiders": "No riders yet",
    "shareMarket.catalog.fromPrice": "From {price}",
    "shareMarket.catalog.listingCount": "{count} Shares",
    "shareMarket.catalog.moreSeats": "+{count} more idle seats",
    "shareMarket.catalog.moreSeatsTotal": "+{count} more seats",
    "shareMarket.catalog.chooseSeat": "Choose a seat",
    "shareMarket.catalog.enabledApps": "Enabled Apps included",
    ...
    "shareMarket.family.openai": "Codex",
    "shareMarket.family.google": "Gemini",
    "shareMarket.family.xai": "Grok",
    "shareMarket.family.cursor": "Cursor",
    "shareMarket.family.kiro": "Kiro",
    "shareMarket.family.copilot": "GitHub Copilot",
    "shareMarket.family.api": "API providers",
    "shareMarket.family.multi": "Multiple providers",
    "shareMarket.family.other": "Other",
    "shareMarket.addShare": "Add",
    ...
    "shareMarket.col.started": "Started",
    "shareMarket.col.ended": "Ended",
    "shareMarket.col.note": "Note",
    "shareMarket.col.actions": "Actions",
    ...
    "shareMarket.rentConfirm.quoteExpiry":
      "This frozen quote expires at {time}. If it expires, request a new quote before committing.",
    ...
    "shareMarket.modelPassthrough": "Passthrough",
    ...
    "shareMarket.rentSelected": "Rent selected seat",
    "shareMarket.blockReason.owner": "You own this Share.",
    "shareMarket.blockReason.already_renting": "You already rent a seat in this Share.",
    "shareMarket.blockReason.direct_access": "You already have direct access to this Share.",
    ...
    "shareMarket.blockReason.credit_required": "Set up seller credit before renting.",
    "shareMarket.blockReason.buyer_restricted": "The seller does not currently allow this account.",
    "shareMarket.blockReason.settlement_required": "Settle the outstanding balance before renting.",
    "shareMarket.blockReason.credit_limit_reached": "The seller credit limit has been reached.",
    "shareMarket.blockReason.relationship_closed": "This seller relationship is closed.",
    "shareMarket.blockReason.unavailable": "This seat cannot be rented right now.",
    ...
    "shareMarket.authorizationFailure.retry": "Retry grant",
    "shareMarket.authorizationFailure.retryTitle": "Retry the original seat grant",
    "shareMarket.authorizationFailure.retryDescription": "Revalidate the frozen rental terms and retry access for {email}. This restores the original subscription and does not consume another trial.",
    "shareMarket.subscription.statusDetail": "Status detail: {reason}",
    "shareMarket.integrity.compatible": "Contract verified",
    "shareMarket.integrity.violated": "Contract mismatch · billing paused for repair",
    "shareMarket.integrity.remediating": "Contract repair is being applied",
    "shareMarket.integrity.terminated": "Contract terminated",
    "shareMarket.integrity.reason.shareMissing": "The Share is no longer registered",
    "shareMarket.integrity.reason.shareInactive": "The Share is not active",
    "shareMarket.integrity.reason.clientUpgradeRequired": "The Share owner must upgrade cc-switch-server",
    "shareMarket.integrity.reason.contractAppsMissing": "The rental contract is missing its App bundle",
    "shareMarket.integrity.reason.contractAppsChanged": "The frozen App bundle no longer matches the rental contract",
    "shareMarket.integrity.reason.requiredAppDisabled": "A contracted App API was disabled",
    "shareMarket.integrity.reason.parallelReduced": "Share concurrency is below the rented limit",
    "shareMarket.integrity.reason.fixedTermNotCovered": "Share expiry no longer covers the fixed term",
    "shareMarket.integrity.reason.upstreamTermNotCovered": "The upstream subscription no longer covers the fixed term",
    "shareMarket.integrity.reason.bindingMissing": "A contracted App has no provider binding",
    "shareMarket.integrity.reason.providerDisabled": "The bound provider was disabled",
    "shareMarket.integrity.reason.bindingUnresolved": "The bound provider can no longer be resolved",
    "shareMarket.integrity.reason.providerBindingChanged": "The provider binding differs from the frozen contract",
    "shareMarket.integrity.reason.providerModelChanged": "The model policy differs from the frozen contract",
    "shareMarket.integrity.reason.requiredAppUnavailable": "A contracted App API is unavailable",
    "shareMarket.integrity.reason.appScopeNotEnforced": "Access to all enabled Apps has not taken effect",
    "shareMarket.integrity.reason.entitlementMissing": "The active market entitlement is missing",
    "shareMarket.integrity.reason.repairTimeout": "The contract repair window expired",
    "shareMarket.integrity.reason.unknown": "The Share no longer matches the frozen rental contract",
    "shareMarket.refund.summary": "Refund {amount} · {status}",
    "shareMarket.refund.status.applied": "credits applied",
    "shareMarket.refund.status.refund_due": "external refund pending",
    "shareMarket.refund.status.settled": "refund completed",
    "shareMarket.termination.title": "End fixed-term rental",
    "shareMarket.termination.description": "Review the required refund before ending access for {email}.",
    "shareMarket.termination.elapsed": "Term elapsed",
    "shareMarket.termination.refundRate": "Refund rate",
    "shareMarket.termination.netBilled": "Cumulative net billing",
    "shareMarket.termination.refundAmount": "Refund due",
    "shareMarket.termination.policy": "Before 50% elapsed, cumulative net billing is refunded in full. From 50% to before 80%, half is refunded. From 80%, the remaining-term proportion is refunded. Credits apply to unbilled usage first, then unpaid invoices; paid invoices become an external refund obligation.",
    "shareMarket.termination.denyNotice": "This also denies future rentals for this account.",
    "shareMarket.termination.confirm": "Confirm termination and refund",
    "shareMarket.termination.expiresIn": "Refund quote expires in {seconds}s",
    "shareMarket.termination.expired": "This refund quote expired. Refresh it before confirming.",
    "shareMarket.termination.refresh": "Refresh refund quote",
    ...
    "shareMarket.error.clientUpgradeRequired": "The Share owner must upgrade cc-switch-server before this rental can continue.",
    "shareMarket.error.shareTokensExhausted": "The Share-wide Token pool is exhausted. Try again after its usage resets.",
    "shareMarket.error.shareOffline": "The Share is offline. Try again after the owner restores its route.",
    "shareMarket.error.shareExpired": "The Share has expired and cannot provide this rental.",
    "shareMarket.error.runtimeStale": "The Share runtime report is stale. Try again after the Client refreshes it.",
    "shareMarket.error.modelUnavailable": "A model required by an enabled App is currently unavailable.",
    "shareMarket.error.contractIncompatible": "The Share configuration no longer matches an active rental contract.",
    "shareMarket.error.requiredAppUnavailable": "One or more enabled App APIs on this Share are unavailable.",
    "shareMarket.error.termUnfulfillable": "The Share or its upstream subscription cannot cover the complete fixed term.",
    "shareMarket.error.settingsProtected": "An active rental protects this Share setting from being reduced.",
    "shareMarket.error.fixedTermRequired": "This refund flow applies only to an active paid fixed-term rental.",
    "shareMarket.error.terminationQuoteRequired": "Review the current refund quote before terminating this fixed-term rental.",
    ...
    "shareMarket.dialog.capacityTokens": "Usage {value}",
    "shareMarket.dialog.capacityExpires": "Expires {value}",
    ...
    "account.nav.group.market": "Marketplace",
    ...
    "account.notifications.hint":
      "Where this account receives Client alerts, such as a Client going offline.",
    "account.notifications.channelTitle": "Delivery channel",
    "account.notifications.channelHint":
      "Alerts are delivered on exactly one channel. Registration messages always stay on email because they carry the Client web password hint.",
    "account.notifications.channel.email": "Email",
    "account.notifications.channel.emailHint": "Receive notifications at the account email.",
    "account.notifications.channel.telegram": "Telegram",
    "account.notifications.channel.telegramHint": "Receive notifications in the bound private chat.",
    "account.notifications.channel.bark": "Bark",
    "account.notifications.channel.barkHint": "Receive notifications on the bound Bark device.",
    "account.notifications.channel.selected": "Selected",
    "account.notifications.channel.needsBinding": "Bind a Telegram chat below to select this channel.",
    "account.notifications.channel.botUnavailable": "The Router Telegram bot is unavailable right now.",
    "account.notifications.channel.needsBarkBinding": "Verify a Bark Push URL below to select this channel.",
    "account.notifications.channel.barkUnavailable": "The Router Bark provider is unavailable right now.",
    "account.notifications.channel.fallbackNotice":
      "The selected channel is unavailable, so alerts are temporarily delivered to the account email.",
    "account.notifications.emailTarget": "Account email:",
    ...
    "account.notifications.boundAt": "Bound at",
    "account.notifications.bind": "Bind Telegram",
    "account.notifications.rebind": "Rebind",
    "account.notifications.unbind": "Unbind",
    "account.notifications.waiting": "Waiting for the bot to receive your /start …",
    "account.notifications.manualHint":
      "If the new tab did not open, use this link, or send the command below to the bot manually. It is single use and expires.",
    "account.notifications.expiresAt": "Expires at:",
    "account.notifications.unbindConfirmTitle": "Unbind this Telegram account?",
    "account.notifications.unbindConfirmDescription":
      "Queued Telegram deliveries will be cancelled and retried by email. A delivery already being sent may still complete.",
    "account.notifications.barkTitle": "Bark device",
    "account.notifications.barkHint": "Paste the complete Push URL from the Bark app. Router verifies it with one test notification before binding.",
    "account.notifications.barkUnavailable": "Bark user notifications are disabled or not fully configured by the Router owner.",
    "account.notifications.barkReady": "Provider ready",
    "account.notifications.barkDisabled": "Provider unavailable",
    "account.notifications.barkServer": "Bark Server",
    "account.notifications.barkDevice": "Device",
    "account.notifications.barkPushUrl": "Bark Push URL",
    "account.notifications.barkPushUrlInvalid": "Enter the complete Push URL from the Bark app. It must belong to the Bark Server configured for this Router.",
    "account.notifications.barkBindRateLimited": "Too many Bark verification attempts. Wait before trying again.",
    "account.notifications.barkConfigurationChanged": "The Bark configuration changed during verification. Check the current Server and try again.",
    "account.notifications.barkBind": "Verify & bind",
    "account.notifications.barkPrivacy": "The device key is encrypted at rest. Its Push URL is never displayed again or written to logs.",
    "account.notifications.historyTitle": "Notification history",
    "account.notifications.historyHint": "Messages prepared for this account during the last 30 days, including failed and suppressed deliveries.",
    "account.notifications.historyChannel": "Filter by channel",
    "account.notifications.historyStatus": "Filter by status",
    "account.notifications.historyAllChannels": "All channels",
    "account.notifications.historyAllStatuses": "All statuses",
    "account.notifications.historySent": "Sent",
    "account.notifications.historyPending": "Processing",
    "account.notifications.historyFailed": "Failed",
    "account.notifications.historySuppressed": "Not sent",
    "account.notifications.historyNoBody": "No message body is available for this record.",
    "account.notifications.historyAttempts": "Attempts: {count}",
    "account.notifications.historySentAt": "Sent {time}",
    "account.notifications.historyFailure": "Reason: {code}",
    "account.notifications.historyEmpty": "No notification records match these filters.",
    "account.notifications.historyLoadMore": "Load more",
    "account.notifications.barkUnbindConfirmTitle": "Unbind this Bark device?",
    "account.notifications.barkUnbindConfirmDescription": "Queued Bark deliveries will be cancelled and retried by email. A delivery already being sent may still complete.",
    ...
    "account.share.seat": "Seat",
    "account.share.quota": "Frozen limits",
    "shareMarket.col.limits": "Limits",
    "account.share.active": "Active rentals",
    "account.share.history": "Rental history",
    "account.share.historyEmpty": "No completed rentals yet.",
    "account.share.loadMore": "Show more history",
    "account.share.activationPending": "Starts with first access dispatch",
    ...
    "account.share.manageHint":
      "Return access here; billing and service history remain available after return.",
    "account.share.providerManageHint":
      "Manage price, access, and seat lifecycle in Share Market.",
    ...
    "account.binanceAuto.title": "Binance",
    "account.binanceAuto.receipts.open": "Receipt history",
    "account.binanceAuto.receipts.title": "Binance receipt history",
    "account.binanceAuto.receipts.scope": "Shows Binance Pay receipts confirmed by Router for Market invoice payments and prepaid top-ups. This is not your complete Binance transaction history.",
    "account.binanceAuto.receipts.empty": "No confirmed Market invoice payments or prepaid top-ups yet.",
    "account.binanceAuto.receipts.kindInvoice": "Invoice payment",
    "account.binanceAuto.receipts.kindTopup": "Prepaid top-up",
    ...
    "account.binanceAuto.receipts.topupStatus": "Top-up status",
    "account.binanceAuto.receipts.creditedAmount": "Credited amount",
    "account.binanceAuto.receipts.creditedAt": "Credited",
    "account.binanceAuto.receipts.fundingIntent": "Funding intent ID",
    ...
    "account.binanceAuto.boundUid": "Bound UID",
    "account.binanceAuto.maskedKey": "API key",
    "account.binanceAuto.permission": "Permissions",
    "account.binanceAuto.permissionVerified": "Read-only verified",
    "account.binanceAuto.permissionUnknown": "Not verified",
    "account.binanceAuto.uidCheck": "UID routing check",
    "account.binanceAuto.uidConfirmed": "Confirmed by Binance Pay history",
    "account.binanceAuto.uidPending": "Receive a small Pay transfer, then verify again",
    "account.binanceAuto.lastPoll": "Last successful poll",
    "account.binanceAuto.region": "Payment home region",
    "account.binanceAuto.boundAt": "First bound",
    "account.binanceAuto.lastVerified": "Last permission check",
    "account.binanceAuto.source.receiver_history": "Incoming Pay history",
    "account.binanceAuto.source.payer_history": "Outgoing Pay history",
    "account.binanceAuto.source.payment_observation": "Observed payment",
    "account.binanceAuto.source.unknown": "Pay history",
    "account.binanceAuto.lastError": "Last error: {code} ({count} consecutive failures)",
    ...
    "account.binanceAuto.loadingAccount": "Loading Binance account information…",
    "account.binanceAuto.confirm": "Confirm binding",
    "account.binanceAuto.preview.uid": "UID detected from this API key",
    "account.binanceAuto.preview.source": "Identity evidence",
    "account.binanceAuto.preview.evidence": "{count} usable records",
    "account.binanceAuto.preview.replace":
      "This will replace UID {previous} with {next} and cancel pending automatic payment intents.",
    ...
    "account.binanceAuto.disableConfirm":
      "Disable automatic confirmation and cancel every pending automatic payment amount?",
    "account.binanceAuto.delete": "Delete credentials",
    "account.binanceAuto.saved": "Binance automatic confirmation is configured.",
    "account.binanceAuto.verified": "Binance credentials verified.",
    "account.binanceAuto.disabled": "Binance automatic confirmation disabled.",
    "account.binanceAuto.deleteConfirm":
      "Permanently delete the encrypted Binance credentials and cancel pending automatic payment intents?",
    "account.binanceAuto.deleted": "Encrypted Binance credentials deleted.",
    ...
    "clientMarket.usageHistory.title": "Recent Client usage",
    "clientMarket.usageHistory.loading": "Loading usage history…",
    "clientMarket.usageHistory.empty": "No Client usage recorded on this host yet.",
    "clientMarket.usageHistory.error": "Could not load usage history.",
    "clientMarket.usageHistory.renter": "Renter",
    "clientMarket.usageHistory.subdomain": "Subdomain",
    "clientMarket.usageHistory.period": "Rental period",
    "clientMarket.usageHistory.charges": "Charges",
    "clientMarket.usageHistory.invoiced": "Invoiced {amount}",
    "clientMarket.usageHistory.unbilled": "Unbilled {amount}",
    "clientMarket.usageHistory.ongoing": "Ongoing",
    "clientMarket.usageHistory.expand": "Show recent Client usage",
    "clientMarket.usageHistory.collapse": "Hide recent Client usage",
    ...
    "clientMarket.importRunning": "Importing",
    ...
    "clientMarket.terminalAccess.duration4h": "4 hours",
    "clientMarket.terminalAccess.duration24h": "24 hours",
    ...
    "marketBilling.runway.prepaid": "Prepaid runway",
    "marketBilling.runway.total": "Total funding runway",
    "marketBilling.runway.warning": "Less than three days of total funding remain. Add prepaid funds now to avoid an interruption.",
    "marketBilling.runway.critical": "Less than one day of total funding remains. Add prepaid funds immediately to keep services running.",
    ...
    "marketFunding.prepaidTotal": "Total prepaid",
    "marketFunding.prepaidHeld": "Held prepaid",
    "marketFunding.prepaidAvailable": "Available prepaid",
    "marketFunding.creditLimit": "Credit limit",
    "marketFunding.creditUsed": "Credit used",
    "marketFunding.creditReserved": "Credit reserved",
    ...
    "marketFunding.rate.current": "Current / day",
    "marketFunding.rate.new": "New / day",
    "marketFunding.rate.projected": "After order / day",
    "marketFunding.runway.prepaid": "Prepaid runway",
    "marketFunding.runway.total": "Total runway",
    "marketFunding.runway.unlimited": "Unlimited",
    "marketFunding.coverage": "One-day coverage",
    "marketFunding.coverageSplit": "One-day funding: {prepaid} prepaid + {credit} credit.",
    "marketFunding.creditWarning": "After this order, one day of projected service funding will use {amount} of supplier credit. Top up prepaid funds to avoid interruption when credit runs out.",
    ...
    "marketFunding.topup.maximumPreset": "Transfer maximum · {amount}",
    "marketFunding.topup.partialNotice": "This is a partial top-up. The current quote will still need at least {remaining}; after it is credited, the quote will be refreshed with the authoritative balance.",
    "marketFunding.topup.transferLimit": "Maximum per transfer: {amount}",
    "marketFunding.topup.custom": "Custom amount (USD)",
    "marketFunding.topup.providerScope": "This prepaid balance is scoped to this supplier and is shared by your paid Share and Client Host services from that supplier.",
    "marketFunding.topup.refundDisclosure": "Unused prepaid funds remain in your supplier account. Refunds are requested from Account → Billing and require supplier review.",
    ...
    "marketFunding.topup.unavailable.routerDisabled": "Binance top-ups are disabled on this Router.",
    "marketFunding.topup.unavailable.routerShadow": "Binance top-ups are still in trial mode on this Router and cannot accept transfers yet.",
    "marketFunding.topup.unavailable.regionRestricted": "Binance top-ups are unavailable from this Router region.",
    "marketFunding.topup.unavailable.temporary": "Binance top-ups are temporarily unavailable. Try again later.",
    "marketFunding.topup.unavailable.credentialStorage": "This Router cannot securely store Binance credentials, so top-ups are unavailable.",
    "marketFunding.topup.unavailable.supplier": "This supplier has not enabled and verified Binance automatic top-ups.",
    "marketFunding.topup.unavailable.settlementRequired": "Settle the open supplier invoice before adding more prepaid funds.",
    "marketFunding.topup.unavailable.relationshipClosed": "This supplier relationship is closed. You can request a refund for any unused prepaid funds, but cannot add more.",
    ...
    "marketBilling.dispute.autoResolveAt": "Automatic resolution",
    "marketBilling.dispute.escalatedAt": "Escalated",
    "marketBilling.dispute.resolvedAt": "Resolved",
    "marketBilling.dispute.resolution": "Resolution",
    "marketBilling.creditNotes.title": "Credits and refunds",
    "marketBilling.creditNotes.serviceCredit": "Service credit",
    "marketBilling.creditNotes.externalRefund": "External refund",
    "marketBilling.creditNotes.reference": "Reference: {reference}",
    ...
    "marketBilling.refund.title": "External refund obligation",
    "marketBilling.refund.amount": "Refund amount",
    "marketBilling.refund.invoice": "Source invoice: {invoice}",
    "marketBilling.refund.due": "Record refund by {date}",
    "marketBilling.refund.recordedAt": "Recorded {date}",
    "marketBilling.refund.reference": "Reference: {reference}",
    "marketBilling.refund.referenceLabel": "External refund reference",
    "marketBilling.refund.referenceRequired": "An external refund reference is required.",
    "marketBilling.refund.awaitingSupplier": "Waiting for the supplier to record the refund",
    "marketBilling.refund.record": "Record refund",
    "marketBilling.refund.privateNotice": "Refund references and billing details remain private to the buyer, supplier, and Router administrators.",
    "marketBilling.refund.status.pending": "Pending",
    "marketBilling.refund.status.overdue": "Overdue",
    "marketBilling.refund.status.recorded": "Recorded",
    ...
    "marketBilling.binance.exactWarning":
      "Transfer this exact amount. The small suffix uniquely identifies this invoice.",
    "marketBilling.binance.copyAmount": "Copy amount",
    "marketBilling.binance.qrAlt": "Binance recipient QR code",
    "marketBilling.binance.receiverUid": "Recipient Binance UID",
    "marketBilling.binance.copyUid": "Copy recipient UID",
    "marketBilling.binance.noteCode": "Optional transfer note",
    "marketBilling.binance.copyNote": "Copy transfer note",
    "marketBilling.binance.remaining": "Time remaining",
    "marketBilling.binance.statusLabel": "Status",
    "marketBilling.binance.status.pending": "Waiting for payment",
    "marketBilling.binance.status.paid": "Payment confirmed",
    "marketBilling.binance.status.expired": "Payment window expired",
    "marketBilling.binance.status.cancelled": "Automatic payment cancelled",
    "marketBilling.binance.status.review": "Manual review required",
    "marketBilling.binance.path":
      "Binance App → Pay → Send → enter the UID → choose USDT → enter the exact amount. Adding the note is optional.",
    "marketBilling.binance.degraded":
      "The provider account is temporarily degraded. Do not pay again; automatic checks will retry, and manual payment remains available.",
    "marketBilling.binance.expiredHint":
      "Already paid? Do not create a new amount. Late transactions remain protected and can still be detected during the grace window.",
    "marketBilling.binance.reviewHint":
      "A payment was observed and requires review. Do not transfer again; use the manual confirmation path only to contact the provider.",
    "marketBilling.binance.lastChecked": "Last checked {date}",
    "marketBilling.binance.refresh": "Generate a new amount",
    "marketBilling.binance.cancel": "Cancel automatic payment",
    "marketBilling.binance.manualFallback": "Use manual payment confirmation instead",
    "marketBilling.binance.refreshConfirm":
      "Generate a new amount? If you already sent the current amount, keep waiting instead.",
    "marketBilling.binance.cancelConfirm":
      "Cancel this automatic payment amount? Any late transfer will require manual review.",
    "marketBilling.binance.copied": "Copied.",
    "marketBilling.binance.copyFailed": "Could not copy. Select and copy the value manually.",
    "marketBilling.binance.admin.title": "Binance reconciliation",
    "marketBilling.binance.admin.hint":
      "Review exceptional transactions. Settlement is allowed only for a positive USDT transaction and an eligible invoice belonging to the same provider account.",
    "marketBilling.binance.admin.unavailable":
      "Binance reconciliation is temporarily unavailable; the rest of Market Billing remains usable.",
    "marketBilling.binance.admin.openCases": "Open: {count}",
    "marketBilling.binance.admin.pending": "Pending intents: {count}",
    "marketBilling.binance.admin.degraded": "Degraded accounts: {count}",
    "marketBilling.binance.admin.degradedDetails": "Accounts requiring operator attention",
    "marketBilling.binance.admin.unknownError": "Unknown polling error",
    "marketBilling.binance.admin.failureCount": "Consecutive failures: {count}",
    "marketBilling.binance.admin.supplier": "Supplier {supplier}",
    "marketBilling.binance.admin.region": "Region {region}",
    "marketBilling.binance.admin.degradedSince": "Degraded since {date}",
    "marketBilling.binance.admin.lastSuccess": "Last success {date}",
    "marketBilling.binance.admin.nextPoll": "Next poll {date}",
    "marketBilling.binance.admin.leaseUntil": "Lease until {date}",
    "marketBilling.binance.admin.scanProgress": "Scan progress: {cursor} → {target}",
    "marketBilling.binance.admin.order": "Binance order {order}",
    "marketBilling.binance.admin.counterparty": "Counterparty {reference}",
    "marketBilling.binance.admin.payerBinance": "Payer Binance ID {reference}",
    ...
    "marketBilling.binance.admin.ignoreConfirm":
      "Ignore this Binance transaction? This decision is recorded in the reconciliation audit trail.",
    ...
    "marketBilling.dialog.auto-pay": "Binance automatic payment",
    ...
    "settings.modelPrices.nav": "Model prices",
    "settings.modelPrices.title": "Model price management",
    "settings.modelPrices.description": "Review every known model, configure Router-wide prices, and preserve each historical generation.",
    "settings.modelPrices.search": "Search model name or key",
    "settings.modelPrices.filter": "Filter model prices",
    "settings.modelPrices.filter.all": "All models",
    "settings.modelPrices.filter.unpriced": "Unpriced",
    "settings.modelPrices.filter.admin": "Admin overrides",
    "settings.modelPrices.filter.derived": "Built-in prices",
    "settings.modelPrices.stat.total": "Known models",
    "settings.modelPrices.stat.priced": "Priced",
    "settings.modelPrices.stat.unpriced": "Unpriced",
    "settings.modelPrices.stat.overrides": "Admin overrides",
    "settings.modelPrices.column.model": "Model",
    "settings.modelPrices.column.status": "Status",
    "settings.modelPrices.column.input": "Input",
    "settings.modelPrices.column.output": "Output",
    "settings.modelPrices.column.cacheRead": "Cache read",
    "settings.modelPrices.column.cacheWrite5m": "Cache write 5m",
    "settings.modelPrices.column.cacheWrite1h": "Cache write 1h",
    "settings.modelPrices.column.effective": "Effective from",
    "settings.modelPrices.column.actions": "Actions",
    "settings.modelPrices.source.derived": "Built-in",
    "settings.modelPrices.source.admin": "Admin override",
    "settings.modelPrices.source.unpriced": "Unpriced",
    "settings.modelPrices.editorTitle": "Configure model price",
    "settings.modelPrices.add": "Add model",
    "settings.modelPrices.displayName": "Display name",
    "settings.modelPrices.history": "Price history",
    "settings.modelPrices.historyTitle": "Price history · {model}",
    "settings.modelPrices.current": "Current",
    "settings.modelPrices.restore": "Restore built-in price",
    "settings.modelPrices.restoreConfirm": "Restore the built-in price for {model}? The administrator generation will remain in history.",
    "settings.modelPrices.empty": "No matching models.",
    "settings.modelPrices.resultCount": "{count} models",
    "settings.modelPrices.revision": "Catalog revision",
    ...
    "settings.pendingRestart": "{count} saved setting(s) are waiting for a Router restart. Open Overview to see which fields.",
    "settings.pendingRestartShort": "pending restart",
    "settings.pendingRestartLabel": "Pending restart",
    "settings.pendingRestartTitle": "Waiting for restart",
    "settings.pendingRestartListDescription":
      "These values are saved, but the running Router still uses the previous process values until restart.",
    "settings.pendingRestartValues": "Saved: {saved} · Runtime: {runtime}",
    "settings.pendingRestartOpenOverview": "Open Overview",
    ...
    "settings.configuredFields": "Managed fields",
    "settings.configurationDomains": "Configuration domains",
    "settings.snapshotGenerated": "Snapshot generated {time}",
    "settings.categoriesAria": "Settings domains",
    "settings.overview": "Overview",
    "settings.search": "Search settings",
    "settings.searchPlaceholder": "Search name, description, group, or environment key",
    "settings.searchResults": "Search results",
    "settings.searchResultCount": "{count} matching field(s)",
    "settings.fieldCount": "{count} fields",
    "settings.changedFieldCount": "{count} changed",
    ...
    "settings.mapRevisionConflictAfterSettings":
      "Router settings were saved, but map display changed elsewhere. The latest map version was loaded and your map draft was preserved for review.",
    "settings.announcementRevisionConflict":
      "Announcement changed elsewhere. The latest saved version was loaded and your draft was preserved for review.",
    "settings.conflictReloadFailed": "The saved version changed, and reloading it failed: {reason}",
    "settings.savedWithMapError": "Router settings were saved, but map display was not saved: {reason}",
    "settings.savedReloadFailed": "Settings were saved, but the latest snapshot could not be reloaded. Reload before editing again.",
    "settings.highRisk": "high risk",
    "settings.groupsAria": "Settings groups",
    "settings.notifications.system": "System alerts",
    "settings.notifications.business": "Business notifications",
    "settings.notifications.email": "Email",
    "settings.notifications.telegram": "Telegram",
    "settings.notifications.bark": "Bark",
    ...
    "settings.alertChannels.title": "Channel verification",
    ...
    "settings.alertChannels.description.telegram":
      "Operator Telegram alerts and the user notification Bot use separate credentials and targets. Verify each independently.",
    "settings.alertChannels.description.bark":
      "Operator Bark alerts and user Bark notifications use separate credentials and targets. Verify each independently.",
    "settings.alertChannels.empty": "No verification status is available for this channel yet.",
    "settings.emailChannel.title": "Email verification",
    "settings.emailChannel.description":
      "Send a test message with the current Resend configuration to the signed-in administrator.",
    "settings.emailChannel.target": "Test recipient: {target}",
    "settings.emailChannel.notConfigured": "Configure the Resend API key and sender address, then save before sending a test.",
    "settings.emailChannel.pendingRestart": "Email settings were saved and will apply after Router restart.",
    "settings.emailChannel.testSent": "Test email sent to {target}.",
    ...
    "settings.alertChannels.operator.barkDescription":
      "Uses the independent operator Bark Server and fixed Device Key configured above.",
    ...
    "settings.alertChannels.user.barkDescription":
      "Uses encrypted per-user Bark device bindings. Tests are sent to the current administrator's bound device.",
    ...
    "settings.alertChannels.diagnostic.title": "Connection diagnosis",
    "settings.alertChannels.diagnostic.details": "Technical details",
    "settings.alertChannels.diagnostic.legacy": "The provider returned a transport error. Check the Router network and retry.",
    "settings.alertChannels.diagnostic.bark.configuration": "The Bark Server or device configuration is incomplete or invalid.",
    "settings.alertChannels.diagnostic.bark.api_timeout": "The configured Bark Server timed out. Check that Server and the Router host network, then retry.",
    "settings.alertChannels.diagnostic.bark.network": "Router could not reach the configured Bark Server. Check DNS, TLS, outbound access, and the reverse proxy.",
    "settings.alertChannels.diagnostic.bark.provider_protocol": "The Bark Server returned an unexpected response. Check its version and reverse-proxy configuration.",
    "settings.alertChannels.diagnostic.bark.target_invalid": "Bark rejected this device key. Rebind the device with its current complete Push URL.",
    "settings.alertChannels.diagnostic.bark.authorization": "The Bark Server refused this request. Check Server and reverse-proxy access controls.",
    "settings.alertChannels.diagnostic.bark.rate_limited": "The Bark Server rate limited this request. Wait for the retry window before testing again.",
    "settings.alertChannels.diagnostic.bark.server_error": "The Bark Server is temporarily unavailable. Router will retry with backoff.",
    "settings.alertChannels.diagnostic.bark.http_error": "The Bark Server returned an unexpected HTTP error. Check the technical details and Server logs.",
    "settings.alertChannels.diagnostic.dns_resolution_failed": "Router could not resolve Telegram API. Check the host DNS configuration and try 8.8.8.8 or 1.1.1.1, then flush the DNS cache and retry.",
    "settings.alertChannels.diagnostic.api_endpoint_unreachable": "DNS returned an address, but Router could not establish a TCP connection to port 443. Check DNS results and outbound TCP 443; try 8.8.8.8 or 1.1.1.1.",
    "settings.alertChannels.diagnostic.api_timeout": "The Telegram API connection timed out. Check DNS results and outbound TCP 443 from the Router host.",
    "settings.alertChannels.diagnostic.tls_handshake_failed": "TCP connected, but TLS negotiation failed. Check the system clock, CA certificates, and TLS interception.",
    "settings.alertChannels.diagnostic.invalid_token": "The Telegram Bot Token is invalid or revoked. Create a new token and save it again.",
    "settings.alertChannels.diagnostic.polling_conflict": "Another process or webhook is consuming this Bot. Stop the other consumer or switch Bot mode.",
    "settings.alertChannels.diagnostic.rate_limited": "Telegram rate limited this request. Wait and retry after the indicated time.",
    "settings.alertChannels.diagnostic.chat_unreachable": "Telegram cannot deliver to this chat. The user may have blocked the Bot or the chat no longer exists.",
    "settings.alertChannels.diagnostic.http_error": "Telegram returned an unexpected HTTP error. Check the technical details and retry.",
    "settings.alertChannels.diagnostic.configuration": "The Telegram Bot configuration is incomplete or invalid.",
    "settings.alertChannels.diagnostic.request_error": "The Telegram request could not be constructed. Check the Router configuration.",
    "settings.alertChannels.diagnostic.response_read_failed": "Router could not read Telegram's response. Retry and inspect the network.",
    "settings.alertChannels.diagnostic.transport_error": "The Telegram network transport failed. Check the Router host network and retry.",
    "settings.alertChannels.diagnostic.resolved": "Resolved addresses: {addresses}",
    "settings.alertChannels.diagnostic.reachable": "Reachable addresses: {addresses}",
    "settings.alertChannels.diagnostic.dnsError": "DNS detail: {error}",
    "operations.title": "Operations",
    "operations.description": "Inspect and control the running Router service, logs, delivery queues, and administrator activity.",
    "operations.navigation": "Operations sections",
    "operations.service": "Service & Version",
    "operations.logs": "Router logs",
    "operations.deliveries": "Notification center",
    "operations.audit": "Admin audit",
    "operations.audit.title": "Administrator audit",
    "operations.audit.description": "Latest privileged actions recorded by this Router.",
    "operations.audit.time": "Time",
    "operations.audit.actor": "Actor",
    "operations.audit.action": "Action",
    "operations.audit.ip": "Source IP",
    "operations.audit.details": "Details",
    "operations.audit.empty": "No administrator actions recorded.",
    ...
    "metrics.clock.offset": "Clock offset",
    "metrics.clock.ntp": "NTP",
    "metrics.clock.quorum": "HTTPS quorum",
    "metrics.clock.confidence": "Confidence",
    "metrics.clock.lastSuccess": "Last successful probe",
    "metrics.clock.rejections": "Ingress rejects (expired / future / contract)",
    "metrics.clock.synchronized": "Synchronized",
    "metrics.clock.unsynchronized": "Not synchronized",
    "metrics.clock.unknown": "Unknown",
    "metrics.clock.sourceFailed": "Probe failed",
    "metrics.clock.disabled": "Clock monitoring disabled",
    "metrics.clock.noData": "No clock quorum samples in this range",
    "metrics.clock.thresholdHint": "warning: behind 15 s / ahead 2 s",
    "metrics.clock.status.healthy": "Healthy",
    "metrics.clock.status.warning": "Warning",
    "metrics.clock.status.critical": "Critical",
    "metrics.clock.status.degraded": "Degraded",
    "metrics.clock.status.disabled": "Disabled",
    "metrics.clock.status.unknown": "Unknown",
    "metrics.tab.overview": "Overview",
    "metrics.tab.host": "Host",
    "metrics.tab.router": "Router",
    "metrics.tab.clients": "Clients",
    "metrics.tab.llm": "LLM",
    "metrics.tab.alerts": "Alerts",
    "metrics.tab.events": "Events",
    "metrics.clients.total": "Clients",
    "metrics.clients.monitored": "{count} monitored",
    "metrics.clients.online": "Online",
    "metrics.clients.onlineDesc": "Authenticated heartbeat is current",
    "metrics.clients.offline": "Offline",
    "metrics.clients.offlineDesc": "Confirmed by the presence state machine",
    "metrics.clients.recovering": "Recovering",
    "metrics.clients.recoveringDesc": "Waiting for stable heartbeats",
    ...
    "metrics.clients.lastSeen": "Last authenticated seen",
    "metrics.clients.offlineSince": "Offline since",
    "metrics.clients.episode": "Episode",
    "metrics.clients.notMonitored": "Not monitored",
    "metrics.clients.status.online": "Online",
    "metrics.clients.status.recovering": "Recovering",
    "metrics.clients.status.offline": "Offline",
    "metrics.clients.status.unknown": "Unknown",
    ...
    "metrics.alerts.silence24h": "Silence 24 hours",
    "metrics.alerts.silence7d": "Silence 7 days",
    "metrics.alerts.noActive": "No active incidents.",
    "metrics.alerts.acknowledge": "Acknowledge",
    "metrics.alerts.silence": "Silence",
    "metrics.alerts.resume": "Resume",
    "metrics.alerts.started": "Started {time}",
    ...
    "metrics.alerts.updated": "Updated",
    "metrics.alerts.error": "Last error",
    "metrics.alerts.retryQueued": "Delivery queued for retry.",
    "metrics.alerts.action.acknowledge.success": "Incident acknowledged.",
    "metrics.alerts.action.silence.success": "Incident silenced.",
    "metrics.alerts.action.resume.success": "Incident notifications resumed.",
    "metrics.alerts.severity.info": "Info",
    "metrics.alerts.severity.warning": "Warning",
    "metrics.alerts.severity.critical": "Critical",
    "metrics.alerts.status.firing": "Firing",
    "metrics.alerts.status.acknowledged": "Acknowledged",
    "metrics.alerts.status.silenced": "Silenced",
    "metrics.alerts.status.resolved": "Resolved",
    "metrics.alerts.delivery.pending": "Pending",
    "metrics.alerts.delivery.claimed": "Sending",
    "metrics.alerts.delivery.retry": "Retry scheduled",
    "metrics.alerts.delivery.sent": "Sent",
    "metrics.alerts.delivery.dead_letter": "Failed",
    "metrics.alerts.delivery.suppressed_disabled": "Channel disabled",
    "metrics.alerts.delivery.superseded": "Superseded",
    ...
    "metrics.detail.validSamples": "{count} valid samples",
    "metrics.chart.systemRisk": "System Risk Trend",
    "metrics.chart.hostPerformance": "Host Performance",
    "metrics.chart.clockOffset": "Router Clock Offset",
    ...
    "metrics.chart.ttftTrend": "TTFT Trend",
    "metrics.chart.tpsTrend": "TPS Trend",
    "metrics.series.rateLimited": "Rate limited (429)",
    "metrics.series.concurrencyLimited": "Concurrency limited (409)",
    "metrics.series.average": "Average",
    ...
    "metrics.panel.clockHealth": "Clock Health",
    "metrics.panel.counters": "Route Lifecycle Counters",
    "metrics.shareControl.title": "Share control queue",
    "metrics.shareControl.description": "Pending delivery, in-flight edits, and revoke operations that exhausted automatic retries.",
    "metrics.shareControl.pending": "Pending",
    "metrics.shareControl.dispatched": "Dispatched",
    "metrics.shareControl.deadLettered": "Dead-lettered",
    "metrics.shareControl.attempts": "{count} attempts",
    "metrics.shareControl.requeue": "Requeue revoke",
    "metrics.shareControl.manualOnly": "Manual investigation required",
    "metrics.shareControl.empty": "No Share control dead letters.",
    "metrics.shareControl.requeued": "Share revoke requeued.",
    "metrics.panel.topConsumers": "Top Consumers",
    "metrics.panel.sharePerformance": "Share Performance",
    "metrics.panel.sharePerformanceDesc":
      "Successful completed streams only; TTFT and output-token TPS use independent valid samples.",
    ...
    "metrics.counter.pendingChannelOpens": "pending SSH channel opens",
    "metrics.counter.channelOpenStarted": "SSH channel opens started",
    "metrics.counter.channelOpenSucceeded": "SSH channel opens succeeded",
    "metrics.counter.channelOpenExplicitFailures": "SSH channel opens rejected by clients",
    "metrics.counter.channelOpenTimeouts": "SSH channel open timeouts",
    "metrics.counter.channelOpenSessionErrors": "SSH channel open session errors",
    "metrics.counter.channelOpenCancelled": "SSH channel opens cancelled",
    "metrics.counter.activeBridges": "active SSH bridges",
    "metrics.counter.bridgeCreated": "SSH bridges created",
    "metrics.counter.bridgeCompleted": "SSH bridges completed",
    "metrics.counter.bridgeCancelled": "SSH bridges cancelled",
    "metrics.counter.bridgeWriteStalls": "SSH bridge write stalls",
    "metrics.counter.bridgeHalfCloseIdle": "SSH bridge half-close idle timeouts",
    "metrics.counter.bridgeIoErrors": "SSH bridge I/O errors",
    "metrics.counter.forwardCapacityRejected": "SSH forward connections rejected at capacity",
    "metrics.counter.shareActiveRequests": "Active Share requests",
    "metrics.counter.shareOldestInflightAge": "Oldest Share request age (s)",
    "metrics.counter.shareOldestProgressAge": "Oldest Share progress age (s)",
    "metrics.counter.shareWatchdogReleases": "Watchdog Share releases",
    "metrics.counter.shareManualReleases": "Manual Share releases",
    "metrics.counter.requestBodyTimeouts": "Request body timeouts",
    "metrics.counter.responseHeaderTimeouts": "Response header timeouts",
    "metrics.counter.downstreamStallTimeouts": "Downstream stall timeouts",
    "metrics.counter.requestHardTimeouts": "Request hard timeouts",
    "metrics.counter.streamSemanticTerminals": "Protocol stream terminals",
    "metrics.counter.streamFirstEventTimeouts": "First-event timeouts",
    "metrics.counter.streamIdleTimeouts": "Stream idle timeouts",
    "metrics.counter.streamParserOverflows": "Stream parser overflows",
    "metrics.counter.streamUpstreamErrors": "Upstream stream errors",
    ...
    "metrics.header.share": "Share",
    "metrics.header.samples": "TTFT / TPS samples",
    "metrics.header.lastRequest": "Last request",
    ...
    "notifications.description":
      "Unified operator-alert and user-notification history across Bark, Telegram, and email.",
    "notifications.search": "Search event, target, or error",
    "notifications.allSources": "All sources",
    "notifications.operatorAlerts": "Operator alerts",
    ...
    "notifications.failedRetrying": "Failed / retrying",
    "notifications.suppressed": "Suppressed",
    "notifications.messagePreview": "Message preview",
    "notifications.operatorTarget": "Operator channel",
    "notifications.pageSummary": "{count} records · {page} / {pages}",
    ...
    "notifications.empty": "No matching notification deliveries.",
    ...
    "notifications.status.cancelledChannelChanged": "cancelled after channel change",
    ...
    "version.upgradeFailed": "Upgrade failed and the binary was left untouched. Details in the upgrade log.",
    "version.upgradeFailedWith": "Upgrade failed, the binary was left untouched: {reason}",
    "dashboard.chat": "Chat",
    ...
    "chat.event.billingFundingRunwayWarning":
      "Total funding for this supplier has less than three days of service runway. Open Billing to add prepaid funds.",
    "chat.event.billingFundingRunwayCritical":
      "Total funding for this supplier has less than one day of service runway. Add prepaid funds now to avoid interruption.",
    "chat.event.billingFundingRunwayRecovered":
      "The low-funding condition for this supplier has cleared.",
    ...
    "chat.detail.alertLevel": "Funding alert",
    ...
    "chat.detail.billingUrl": "Open Billing",
    ...
    "chat.detail.lastHeartbeatAt": "Last trusted heartbeat",
    ...
    "modelHub.optional": "Unified endpoint · optional",
    "modelHub.endpoint": "Unified endpoint",
    "modelHub.apiKey": "API key",
    "modelHub.routes": "Model routes",
    "modelHub.addRoute": "Add model",
    "modelHub.app": "Protocol",
    "modelHub.protocol.claude": "Anthropic",
    "modelHub.protocol.codex": "OpenAI",
    "modelHub.protocol.gemini": "Gemini",
    "modelHub.status.empty": "Not configured",
    "modelHub.status.passthrough": "Passthrough",
    "modelHub.status.exact": "{count} models",
    "modelHub.status.mixed": "Passthrough + {count} models",
    "modelHub.status.attention": "Needs attention",
    "modelHub.emptyProtocol": "Requests for this protocol on the unified API fail until a passthrough or at least one model is set.",
    "modelHub.passthrough": "Passthrough (other models)",
    "modelHub.passthroughUnset": "Not set",
    "modelHub.passthroughHint.none": "Any model name is forwarded to this Share unchanged.",
    "modelHub.passthroughHint.mixed": "Only models not listed below go here. The model name is forwarded unchanged.",
    "modelHub.exactModels": "Specific models",
    "modelHub.exactEmpty": "None",
    "modelHub.listMode.passthrough": "Model list: forwarded from this Share, same as calling it directly.",
    "modelHub.listMode.mixed": "Model list: synthesized from the names below. The passthrough Share catalog is not returned as-is.",
    "modelHub.listMode.exact": "Model list: only the names below. Other models fail.",
    "modelHub.listMode.empty": "No models are advertised for this protocol.",
    "modelHub.expandRoutes": "Edit routes",
    "modelHub.collapseRoutes": "Hide routes",
    "modelHub.unsavedTitle": "Discard unsaved routes?",
    "modelHub.unsavedDescription": "Hiding the editor reloads the last saved routes for Anthropic, OpenAI, and Gemini.",
    "modelHub.unsavedDiscard": "Discard",
    "modelHub.summary.empty": "Not configured",
    "modelHub.model": "Requested model",
    "modelHub.modelPlaceholder": "Exact model name",
    "modelHub.targetShare": "Target Share",
    "modelHub.removeRoute": "Remove route",
    "modelHub.empty": "No unified model routes configured.",
    "modelHub.validationRequired": "Every route requires an exact model name and target Share.",
    "modelHub.validationDuplicate": "Each protocol and model pair can have only one target Share.",
    "modelHub.validationTooMany": "At most 100 model routes can be configured.",
    "modelHub.validationPattern": "`*` routes every model. Partial patterns like `gpt-*` are not supported.",
    "modelHub.addWildcard": "All models",
    "modelHub.addWildcardHint": "Route every model of one protocol to a single Share. One per protocol.",
    "modelHub.wildcardLabel": "All models (passthrough)",
    "modelHub.wildcardHint": "Every model not matched by an exact route above goes to this Share. The model name is forwarded unchanged.",
    "modelHub.wildcardPassthroughHint": "This protocol has only this route, so the unified API is a plain forwarding layer for this Share: the model list comes straight from it, and requests behave exactly as if you called the Share directly.",
    "modelHub.targetUnavailable": "Target unavailable or no longer authorized",
    "modelHub.resetKeyImpact": "Resetting this key immediately invalidates it for both the unified endpoint and every direct Share endpoint.",
    "modelHub.directEndpoint": "Direct",
    "modelHub.modelPending": "model pending",
    "modelHub.noRoutesForShare": "No unified routes",
    "modelHub.addRouteForShare": "Add a model route to this Share",
    "modelHub.mapModel": "Map",
    "modelHub.protocolTabs": "Protocol routes",
    "modelHub.configTitle": "Routes",
    "modelHub.test.title": "Test",
    "modelHub.test.run": "Run test",
    "modelHub.test.running": "Testing…",
    "modelHub.test.saveFirst": "Save routes before testing. The test uses the last saved configuration, not this draft.",
    "modelHub.test.needModel": "Enter a callable model name. `*` is a route, not a model you can call.",
    "modelHub.test.needRoute": "Configure a passthrough or at least one model, then save, before testing.",
    "modelHub.test.wildcardHint": "Passthrough forwards whatever name you type. Use a real model this Share accepts.",
    "modelHub.test.matchedExact": "Matched an exact route",
    "modelHub.test.matchedPassthrough": "Matched passthrough",
    "modelHub.test.model": "Test model",
    "modelHub.test.curl": "curl",
    "modelHub.test.response": "Response",
    "modelHub.test.headers": "Headers",
    "modelHub.test.body": "Body",
    "modelHub.test.bodyTruncated": "Body truncated",
    "modelHub.test.durationMs": "{ms} ms",
    "modelHub.test.networkError": "Test failed: {message}",
    "modelHub.test.empty": "Nothing to test until this protocol has a saved route.",
    "modelHub.test.target": "Target Share",
    "dashboard.all": "All",
    ...
    "dashboard.totalThroughput": "TTFT/TPS",
    "dashboard.ttftTpsHint":
      "Latest 10 requests · valid TTFT samples: {ttftSamples} · valid TPS samples: {tpsSamples}",
    ...
    "dashboard.connectDialog.credentials": "Credentials",
    ...
    "dashboard.connectDialog.test.section": "End-to-end connection test",
    ...
    "dashboard.connectDialog.test.policyPassthrough":
      "Requests pass through to {provider}; use a model name supported by that Provider.",
    "dashboard.connectDialog.test.policySingle":
      "Every requested model name maps to the fixed upstream model {model}.",
    "dashboard.connectDialog.test.policyUnknown":
      "Model routing follows the bound Provider configuration.",
    "dashboard.connectDialog.test.providerUnknown": "the bound Provider",
    "dashboard.connectDialog.test.testModel": "Test model",
    "dashboard.connectDialog.test.curlLabel": "curl",
    "dashboard.connectDialog.test.responseToggle": "Response",
    ...
    "dashboard.healthCalendar.inactiveNow": "Not currently eligible for model monitoring",
    "dashboard.healthCalendar.sharedProbe": "Shared upstream probe",
    "dashboard.healthCalendar.legacyEvidence":
      "History includes legacy evidence and is informational only.",
    "dashboard.healthCalendar.unavailable": "Upstream model availability history is unavailable.",
    "dashboard.healthCalendar.day":
      "{date}: {rate}% available ({successful}/{expected} successful; {observed} observed; {upstreamFailures} confirmed upstream-side failures; {gaps} monitoring gaps; {coverage}% coverage)",
    "dashboard.healthCalendar.inactiveDay": "{date}: outside the monitoring eligibility window",
    "dashboard.healthCalendar.mixedEpoch": "Probe configuration changed during this day.",
    "dashboard.healthCalendar.legacyDay": "This day contains legacy evidence.",
    "dashboard.healthCalendar.lower": "Lower",
    "dashboard.healthCalendar.higher": "Higher",
    "dashboard.clientOnlineCalendar.title": "Client uptime",
    "dashboard.clientOnlineCalendar.hint": "Tunnel probes since this Client was registered.",
    "dashboard.clientOnlineCalendar.schedule": "{days} observed days · {timezone}",
    "dashboard.clientOnlineCalendar.unavailable": "Client uptime history is unavailable.",
    "dashboard.clientOnlineCalendar.day":
      "{date}: {rate}% online ({online}/{observed} observed minutes)",
    "dashboard.clientOnlineCalendar.unobservedDay": "{date}: no tunnel probe",
    ...
    "dashboard.noMyShares": "No Shares you own, can use through ShareTo, or have already routed",
    ...
    "dashboard.operationalQuality": "Operations",
    "dashboard.warningCount": "{count} warnings",
    "dashboard.noWarnings": "no warnings",
    "dashboard.noEnabledShares": "No enabled Shares",
    "dashboard.availability": "availability",
    "dashboard.issues": "issues",
    "dashboard.searchClients": "Search client, share",
    "dashboard.searchShares": "Search share, subdomain, provider",
    ...
    "dashboard.modelPolicyPassthrough": "Passthrough",
    ...
    "dashboard.sharesAvailableDetail":
      "Service-ready: {available}/{total}. Routes online: {routeOnline}/{total}. Shares with operational warnings: {warnings}/{total}.",
    ...
    "dashboard.videoJobs": "Videos",
    "dashboard.connectDialog.test.operationText": "Text",
    "dashboard.connectDialog.test.operationImageGeneration": "Generate image",
    "dashboard.connectDialog.test.operationImageEdit": "Edit image",
    "dashboard.connectDialog.test.operationVideoGeneration": "Generate video",
    ...
    "dashboard.shareEdit.descriptionPlaceholder": "Share description",
    "dashboard.shareEdit.section.market": "App APIs",
    ...
    "dashboard.shareEdit.appApiUnbound": "Not bound",
    ...
    "dashboard.shareRecentErrors.status": "HTTP {code}",
    "dashboard.shareRecentErrors.caller": "Caller",
    "dashboard.shareRecentErrors.anonymous": "No caller email",
    "dashboard.shareRecentErrors.truncated": "Body truncated after 8 KiB",
    "dashboard.shareRecentErrors.time": "Time",
    "dashboard.shareRecentErrors.request": "Request",
    "dashboard.shareRecentErrors.reason.buffered": "Captured response body",
    "dashboard.shareRecentErrors.reason.sse_not_buffered":
      "Streaming response; body was not buffered",
    "dashboard.shareRecentErrors.reason.empty_body": "Empty response body",
    "dashboard.shareRecentErrors.reason.read_failed": "Response body could not be fully read",
    "dashboard.shareRecentErrors.reason.router_local": "Router-local error",
    ...
    "dashboard.userLimit.title": "Authorized users & quotas",
    ...
    "dashboard.userLimit.byModel.coverage":
      "{coverage}% of tokens priced · {estimated}% of requests estimated",
    "dashboard.userLimit.price.configure": "Set price",
    "dashboard.userLimit.price.edit": "Edit price",
    "dashboard.userLimit.price.title": "Set model price",
    "dashboard.userLimit.price.editTitle": "Edit model price",
    "dashboard.userLimit.price.globalHint": "This price applies to this model across every Share on the Router.",
    "dashboard.userLimit.price.input": "Input · USD / 1M tokens",
    "dashboard.userLimit.price.output": "Output · USD / 1M tokens",
    "dashboard.userLimit.price.cacheRead": "Cache read · USD / 1M tokens",
    "dashboard.userLimit.price.cacheWrite5m": "Cache write 5m · USD / 1M tokens",
    "dashboard.userLimit.price.cacheWrite1h": "Cache write 1h · USD / 1M tokens (optional)",
    "dashboard.userLimit.price.calculationDetails": "Calculation details",
    ...
    "dashboard.hint.freeAccess":
      "Off by default. When enabled, any signed-in Router user can invoke the Share with their own Router API Token; it is not anonymous public access.",
    "dashboard.hint.freeAccessUserOverrides":
      "Authorized users below remain useful as per-user quota overrides; they are not an allowlist while public free access is enabled.",
    ...
    "dashboard.emailTokenUsageSubtitle": "All apps · {total} tokens",
    ...
    "dashboard.usageEmail.role.sharemarket": "sharemarket",
    "dashboard.usageEmail.role.gateway": "gateway",
  ...
  "zh-CN": {
    ...
    "nav.logout": "退出登录",
    "nav.login": "登录",
    "clientLogs.button": "日志",
    "clientLogs.title": "Client 日志",
    "clientLogs.refresh": "刷新日志",
    "clientLogs.pauseAutoRefresh": "禁止自动刷新",
    "clientLogs.resumeAutoRefresh": "恢复自动刷新",
    "clientLogs.logText": "只读 Client 日志",
    "clientLogs.loading": "正在读取日志...",
    "clientLogs.empty": "暂无日志。",
    "clientLogs.error.loginRequired": "登录后才能查看 Server 进程日志。",
    "clientLogs.error.forbidden": "只有 Router 管理员或该 Client owner 可以查看进程日志。",
    "clientLogs.error.disabled": "该 Server 未启用 INFO 日志采集。",
    "clientLogs.error.busy": "Client 日志读取繁忙，将稍后自动重试。",
    "clientLogs.error.offline": "Client 当前离线或正在重连，暂时无法读取进程日志。",
    ...
    "shareMarket.catalog.familyIdleHint": "{family}：{count} 个空闲车位",
    "shareMarket.catalog.mine": "我的",
    "shareMarket.catalog.mineHint": "只看你正在租用的 Share",
    "shareMarket.catalog.mineSeat": "我的",
    "shareMarket.catalog.mineEmpty": "当前筛选下没有你正在租用的 Share。",
    "shareMarket.catalog.previousPage": "上一页",
    "shareMarket.catalog.nextPage": "下一页",
    "shareMarket.catalog.page": "第 {page} / {pages} 页",
    "shareMarket.catalog.myRentals": "我的租用（{count}）",
    "shareMarket.catalog.empty": "没有符合当前搜索的 Share。",
    "shareMarket.catalog.availabilityFilter": "按空闲车位筛选",
    "shareMarket.catalog.availability.all": "全部 Share",
    "shareMarket.catalog.availability.idle": "只看有空位",
    ...
    "shareMarket.catalog.providerUnknown": "暂无供应商详情",
    "shareMarket.catalog.terms": "拼车位条款",
    "shareMarket.catalog.serviceTerm": "服务期限",
    "shareMarket.catalog.billingStart": "开始计费",
    "shareMarket.catalog.afterTrial": "健康服务满 {hours} 小时后",
    "shareMarket.catalog.serviceQuality": "服务质量",
    "shareMarket.catalog.samples": "最近请求",
    "shareMarket.catalog.observedMinutes": "观测分钟数",
    "shareMarket.catalog.seller": "卖家",
    "shareMarket.catalog.otherSeats": "该 Share 的其他拼车位",
    "shareMarket.catalog.idleSeats": "{count} 个空闲车位",
    "shareMarket.catalog.occupancy": "{idle}/{total} 空闲",
    "shareMarket.catalog.full": "暂无空闲车位",
    "shareMarket.catalog.seatsAndRiders": "拼车位与拼车用户",
    "shareMarket.catalog.shareSeats": "Share 拼车位",
    "shareMarket.catalog.anonymousRider": "拼车用户",
    "shareMarket.catalog.noRiders": "暂无拼车用户",
    "shareMarket.catalog.fromPrice": "{price} 起",
    "shareMarket.catalog.listingCount": "{count} 个 Share",
    "shareMarket.catalog.moreSeats": "另有 {count} 个空闲车位",
    "shareMarket.catalog.moreSeatsTotal": "另有 {count} 个拼车位",
    "shareMarket.catalog.chooseSeat": "选择拼车位",
    "shareMarket.catalog.enabledApps": "包含的已启用 App",
    ...
    "shareMarket.family.kiro": "Kiro",
    "shareMarket.family.copilot": "GitHub Copilot",
    "shareMarket.family.api": "API 供应商",
    "shareMarket.family.multi": "多供应商",
    "shareMarket.family.other": "其他",
    "shareMarket.addShare": "添加",
    ...
    "shareMarket.col.started": "开始时间",
    "shareMarket.col.ended": "结束时间",
    "shareMarket.col.note": "备注",
    "shareMarket.col.actions": "操作",
    ...
    "shareMarket.rentConfirm.quoteExpiry":
      "本次冻结报价将在 {time} 失效；过期后需重新获取报价再提交。",
    "shareMarket.rentConfirm.serviceFixed":
    ...
    "shareMarket.modelPassthrough": "透传",
    ...
    "shareMarket.rent": "租用",
    "shareMarket.rentSelected": "租用所选车位",
    "shareMarket.blockReason.owner": "这是你自己的 Share。",
    "shareMarket.blockReason.already_renting": "你已租用该 Share 的一个拼车位。",
    "shareMarket.blockReason.direct_access": "你已拥有该 Share 的直接访问权限。",
    ...
    "shareMarket.blockReason.credit_required": "请先建立卖家授信。",
    "shareMarket.blockReason.buyer_restricted": "卖家当前不允许此账号租用。",
    "shareMarket.blockReason.settlement_required": "请先结清未付余额。",
    "shareMarket.blockReason.credit_limit_reached": "卖家授信额度已用满。",
    "shareMarket.blockReason.relationship_closed": "与该卖家的交易关系已关闭。",
    "shareMarket.blockReason.unavailable": "该拼车位当前无法租用。",
    ...
    "shareMarket.authorizationFailure.retry": "重试授权",
    "shareMarket.authorizationFailure.retryTitle": "重试原拼车位授权",
    "shareMarket.authorizationFailure.retryDescription": "重新校验冻结的租用条款，并为 {email} 重试授权。该操作恢复原租用，不会重复消耗试用额度。",
    "shareMarket.subscription.statusDetail": "状态详情：{reason}",
    "shareMarket.integrity.compatible": "合同校验正常",
    "shareMarket.integrity.violated": "合同配置不一致 · 已停计费并等待修复",
    "shareMarket.integrity.remediating": "正在应用合同修复",
    "shareMarket.integrity.terminated": "合同已终止",
    "shareMarket.integrity.reason.shareMissing": "Share 已不在 Router 中",
    "shareMarket.integrity.reason.shareInactive": "Share 当前未启用",
    "shareMarket.integrity.reason.clientUpgradeRequired": "Share 供应方需要升级 cc-switch-server",
    "shareMarket.integrity.reason.contractAppsMissing": "租用合同缺少 App 范围快照",
    "shareMarket.integrity.reason.contractAppsChanged": "冻结的 App 范围与租用合同不再一致",
    "shareMarket.integrity.reason.requiredAppDisabled": "合同包含的某个 App API 已被停用",
    "shareMarket.integrity.reason.parallelReduced": "Share 并发已低于租用上限",
    "shareMarket.integrity.reason.fixedTermNotCovered": "Share 有效期已无法覆盖固定租期",
    "shareMarket.integrity.reason.upstreamTermNotCovered": "上游订阅有效期已无法覆盖固定租期",
    "shareMarket.integrity.reason.bindingMissing": "合同包含的某个 App 缺少供应商绑定",
    "shareMarket.integrity.reason.providerDisabled": "绑定的供应商已被停用",
    "shareMarket.integrity.reason.bindingUnresolved": "已无法解析绑定的供应商",
    "shareMarket.integrity.reason.providerBindingChanged": "供应商绑定与冻结合同不一致",
    "shareMarket.integrity.reason.providerModelChanged": "模型策略与冻结合同不一致",
    "shareMarket.integrity.reason.requiredAppUnavailable": "合同包含的某个 App API 当前不可用",
    "shareMarket.integrity.reason.appScopeNotEnforced": "全部已启用 App 的访问权限尚未生效",
    "shareMarket.integrity.reason.entitlementMissing": "有效的市场授权已丢失",
    "shareMarket.integrity.reason.repairTimeout": "合同修复期限已超时",
    "shareMarket.integrity.reason.unknown": "Share 当前配置与冻结的租用合同不一致",
    "shareMarket.refund.summary": "退款 {amount} · {status}",
    "shareMarket.refund.status.applied": "抵扣已生效",
    "shareMarket.refund.status.refund_due": "等待线下退款",
    "shareMarket.refund.status.settled": "退款已完成",
    "shareMarket.termination.title": "提前终止固定期租用",
    "shareMarket.termination.description": "终止 {email} 的访问前，请复核必须承担的退款。",
    "shareMarket.termination.elapsed": "已履约比例",
    "shareMarket.termination.refundRate": "退款比例",
    "shareMarket.termination.netBilled": "累计净计费",
    "shareMarket.termination.refundAmount": "应退金额",
    "shareMarket.termination.policy": "履约不足 50% 时，全额退还累计净计费；达到 50% 且不足 80% 时退一半；达到 80% 后按剩余期限比例退款。退款依次抵扣未出账费用、未支付发票；已支付发票会生成线下退款义务。",
    "shareMarket.termination.denyNotice": "同时会拒绝该账号后续租用。",
    "shareMarket.termination.confirm": "确认终止并退款",
    "shareMarket.termination.expiresIn": "退款报价将在 {seconds} 秒后过期",
    "shareMarket.termination.expired": "退款报价已过期，请刷新后再确认。",
    "shareMarket.termination.refresh": "刷新退款报价",
    ...
    "shareMarket.error.clientUpgradeRequired": "Share Owner 需要先升级 cc-switch-server，才能继续该租用流程。",
    "shareMarket.error.shareTokensExhausted": "Share 的共享 Token 池已耗尽，请在用量重置后重试。",
    "shareMarket.error.shareOffline": "Share 当前离线，请等待 Owner 恢复路由后重试。",
    "shareMarket.error.shareExpired": "Share 已过期，无法继续提供该租用服务。",
    "shareMarket.error.runtimeStale": "Share runtime 报告已过期，请等待 Client 刷新后重试。",
    "shareMarket.error.modelUnavailable": "某个已启用 App 所需的模型当前不可用。",
    "shareMarket.error.contractIncompatible": "Share 当前配置与生效中的租用合同不一致。",
    "shareMarket.error.requiredAppUnavailable": "该 Share 有一个或多个已启用 App API 当前不可用。",
    "shareMarket.error.termUnfulfillable": "Share 或上游订阅无法覆盖完整固定期限。",
    "shareMarket.error.settingsProtected": "生效中的租用合同保护该 Share 设置，不能缩减。",
    "shareMarket.error.fixedTermRequired": "该退款流程仅适用于已生效的付费固定期租用。",
    "shareMarket.error.terminationQuoteRequired": "提前终止固定期租用前，请先复核当前退款预览。",
    ...
    "shareMarket.dialog.capacityTokens": "用量 {value}",
    "shareMarket.dialog.capacityExpires": "过期时间 {value}",
    ...
    "account.nav.group.security": "访问与安全",
    "account.nav.group.usage": "用量",
    "account.nav.group.market": "市场交易",
    "account.nav.apiKeys": "API 密钥",
    "account.nav.notifications": "通知设置",
    ...
    "account.notifications.title": "通知设置",
    "account.notifications.hint": "本账号接收 Client 告警（例如 Client 离线）的方式。",
    "account.notifications.channelTitle": "投递渠道",
    "account.notifications.channelHint":
      "告警只会投递到一个渠道。注册消息始终走邮件，因为其中包含 Client Web 密码提示。",
    "account.notifications.channel.email": "邮件",
    "account.notifications.channel.emailHint": "在账号邮箱接收通知。",
    "account.notifications.channel.telegram": "Telegram",
    "account.notifications.channel.telegramHint": "在已绑定的私聊中接收通知。",
    "account.notifications.channel.bark": "Bark",
    "account.notifications.channel.barkHint": "在已绑定的 Bark 设备上接收通知。",
    "account.notifications.channel.selected": "当前渠道",
    "account.notifications.channel.needsBinding": "先在下方绑定 Telegram 私聊，才能切换到该渠道。",
    "account.notifications.channel.botUnavailable": "Router 的 Telegram 机器人当前不可用。",
    "account.notifications.channel.needsBarkBinding": "先在下方验证 Bark Push URL，才能切换到该渠道。",
    "account.notifications.channel.barkUnavailable": "Router 的 Bark 服务当前不可用。",
    "account.notifications.channel.fallbackNotice":
      "当前选择的渠道不可用，告警会暂时投递到账号邮箱。",
    ...
    "account.notifications.boundAt": "绑定时间",
    "account.notifications.bind": "绑定 Telegram",
    "account.notifications.rebind": "重新绑定",
    "account.notifications.unbind": "解绑",
    "account.notifications.waiting": "等待机器人收到 /start …",
    "account.notifications.manualHint":
      "如果没有自动打开新标签页，可使用下面的链接，或手动把命令发给机器人。链接一次性使用且会过期。",
    "account.notifications.expiresAt": "过期时间：",
    "account.notifications.unbindConfirmTitle": "解绑该 Telegram 账号？",
    "account.notifications.unbindConfirmDescription":
      "排队中的 Telegram 通知会取消并改由邮件重试；已经开始发送的通知仍可能完成。",
    "account.notifications.barkTitle": "Bark 设备",
    "account.notifications.barkHint": "粘贴 Bark App 中的完整 Push URL；Router 会先发送一条验证通知，成功后才完成绑定。",
    "account.notifications.barkUnavailable": "Router owner 尚未启用 Bark 用户通知，或配置尚不完整。",
    "account.notifications.barkReady": "服务已就绪",
    "account.notifications.barkDisabled": "服务不可用",
    "account.notifications.barkServer": "Bark Server",
    "account.notifications.barkDevice": "设备",
    "account.notifications.barkPushUrl": "Bark Push URL",
    "account.notifications.barkPushUrlInvalid": "请输入 Bark App 中的完整 Push URL，且它必须属于当前 Router 配置的 Bark Server。",
    "account.notifications.barkBindRateLimited": "Bark 验证尝试过于频繁，请稍后再试。",
    "account.notifications.barkConfigurationChanged": "验证期间 Bark 配置发生了变化，请确认当前 Server 后重试。",
    "account.notifications.barkBind": "验证并绑定",
    "account.notifications.barkPrivacy": "Device Key 会加密保存；完整 Push URL 不会再次显示，也不会写入日志。",
    "account.notifications.historyTitle": "通知记录",
    "account.notifications.historyHint": "查看最近 30 天为此账户生成的消息，包括失败和未发送的投递。",
    "account.notifications.historyChannel": "按渠道筛选",
    "account.notifications.historyStatus": "按状态筛选",
    "account.notifications.historyAllChannels": "全部渠道",
    "account.notifications.historyAllStatuses": "全部状态",
    "account.notifications.historySent": "已发送",
    "account.notifications.historyPending": "处理中",
    "account.notifications.historyFailed": "失败",
    "account.notifications.historySuppressed": "未发送",
    "account.notifications.historyNoBody": "此记录没有可显示的消息正文。",
    "account.notifications.historyAttempts": "尝试次数：{count}",
    "account.notifications.historySentAt": "发送于 {time}",
    "account.notifications.historyFailure": "原因：{code}",
    "account.notifications.historyEmpty": "当前筛选条件下没有通知记录。",
    "account.notifications.historyLoadMore": "加载更多",
    "account.notifications.barkUnbindConfirmTitle": "解绑该 Bark 设备？",
    "account.notifications.barkUnbindConfirmDescription": "排队中的 Bark 通知会取消并改由邮件重试；已经开始发送的通知仍可能完成。",
    "account.apiKeys.title": "API Token",
    "account.apiKeys.hint":
    ...
    "account.share.seat": "拼车位",
    "account.share.quota": "冻结限制",
    "shareMarket.col.limits": "限制",
    "account.share.active": "进行中的租用",
    "account.share.history": "租用历史",
    "account.share.historyEmpty": "暂无已结束的租用。",
    "account.share.loadMore": "查看更多历史",
    "account.share.activationPending": "首次下发访问权限时开始",
    "account.share.deadline": "截止时间",
    "account.share.noDeadline": "—",
    "account.share.updated": "最近更新",
    "account.share.readOnlyHint": "此处只读 — 请到 Share Market 管理。",
    "account.share.manageHint":
      "可在此归还权限；归还后仍可查看账务和服务历史。",
    "account.share.providerManageHint":
      "请到 Share Market 管理价格、访问权限和拼车位生命周期。",
    ...
    "account.binanceAuto.title": "币安",
    "account.binanceAuto.receipts.open": "到账记录",
    "account.binanceAuto.receipts.title": "币安到账记录",
    "account.binanceAuto.receipts.scope": "展示 Router 已确认的 Market 账单收款和预存充值币安 Pay 到账，不代表币安账户的全部交易流水。",
    "account.binanceAuto.receipts.empty": "暂无已确认的 Market 账单收款或预存充值。",
    "account.binanceAuto.receipts.kindInvoice": "账单收款",
    "account.binanceAuto.receipts.kindTopup": "预存充值",
    ...
    "account.binanceAuto.receipts.topupStatus": "充值状态",
    "account.binanceAuto.receipts.creditedAmount": "入账金额",
    "account.binanceAuto.receipts.creditedAt": "入账时间",
    "account.binanceAuto.receipts.fundingIntent": "充值 Intent ID",
    ...
    "account.binanceAuto.boundUid": "已绑定 UID",
    "account.binanceAuto.maskedKey": "API Key",
    "account.binanceAuto.permission": "权限",
    "account.binanceAuto.permissionVerified": "只读权限已验证",
    "account.binanceAuto.permissionUnknown": "尚未验证",
    "account.binanceAuto.uidCheck": "UID 路由确认",
    "account.binanceAuto.uidConfirmed": "已通过 Binance Pay 流水确认",
    "account.binanceAuto.uidPending": "请先接收一笔小额 Pay 转账，再重新验证",
    "account.binanceAuto.lastPoll": "最近成功轮询",
    "account.binanceAuto.region": "付款归属 Region",
    "account.binanceAuto.boundAt": "首次绑定时间",
    "account.binanceAuto.lastVerified": "最近权限检查",
    "account.binanceAuto.source.receiver_history": "收款 Pay 流水",
    "account.binanceAuto.source.payer_history": "付款 Pay 流水",
    "account.binanceAuto.source.payment_observation": "到账观察",
    "account.binanceAuto.source.unknown": "Pay 流水",
    "account.binanceAuto.lastError": "最近错误：{code}（连续 {count} 次失败）",
    "account.binanceAuto.apiKey": "币安只读 API Key",
    "account.binanceAuto.apiSecret": "API Secret",
    "account.binanceAuto.readOnlyWarning":
      "仅开启读取权限；交易、提现和全部转账权限必须保持关闭。",
    "account.binanceAuto.loadingAccount": "正在加载币安账户信息…",
    "account.binanceAuto.confirm": "确认绑定",
    "account.binanceAuto.preview.uid": "该 API Key 自动识别的 UID",
    "account.binanceAuto.preview.source": "身份确认依据",
    "account.binanceAuto.preview.evidence": "{count} 条有效流水",
    "account.binanceAuto.preview.replace":
      "确认后将把 UID {previous} 更换为 {next}，并取消待处理的自动付款意图。",
    ...
    "account.binanceAuto.delete": "删除凭据",
    "account.binanceAuto.saved": "币安自动到账确认已配置。",
    "account.binanceAuto.verified": "币安凭据验证通过。",
    "account.binanceAuto.disabled": "币安自动到账确认已停用。",
    "account.binanceAuto.deleteConfirm": "永久删除加密的币安凭据，并取消所有待处理的自动付款金额？",
    "account.binanceAuto.deleted": "加密的币安凭据已删除。",
    ...
    "clientMarket.usageHistory.title": "最近 Client 使用",
    "clientMarket.usageHistory.loading": "正在加载使用历史…",
    "clientMarket.usageHistory.empty": "此主机还没有 Client 使用记录。",
    "clientMarket.usageHistory.error": "无法加载使用历史。",
    "clientMarket.usageHistory.renter": "租用人",
    "clientMarket.usageHistory.subdomain": "子域名",
    "clientMarket.usageHistory.period": "租用时间",
    "clientMarket.usageHistory.charges": "费用",
    "clientMarket.usageHistory.invoiced": "已出账 {amount}",
    "clientMarket.usageHistory.unbilled": "未出账 {amount}",
    "clientMarket.usageHistory.ongoing": "进行中",
    "clientMarket.usageHistory.expand": "展开最近 Client 使用",
    "clientMarket.usageHistory.collapse": "收起最近 Client 使用",
    ...
    "clientMarket.importRunning": "正在导入",
    ...
    "clientMarket.terminalAccess.duration1h": "1 小时",
    "clientMarket.terminalAccess.duration4h": "4 小时",
    "clientMarket.terminalAccess.duration24h": "24 小时",
    "clientMarket.terminalAccess.authorize": "授权",
    ...
    "marketBilling.runway.prepaid": "预存可用时长",
    "marketBilling.runway.total": "总资金可用时长",
    "marketBilling.runway.warning": "总资金不足 3 天，请及时充值预存，避免服务中断。",
    "marketBilling.runway.critical": "总资金不足 1 天，请立即充值预存以保持服务运行。",
    ...
    "marketFunding.prepaidTotal": "预存总额",
    "marketFunding.prepaidHeld": "冻结预存",
    "marketFunding.prepaidAvailable": "可用预存",
    "marketFunding.creditLimit": "信用额度",
    "marketFunding.creditUsed": "已用授信",
    "marketFunding.creditReserved": "预占授信",
    "marketFunding.creditAvailable": "可用授信",
    "marketFunding.credit.unlimited": "无限额度",
    "marketFunding.credit.none": "未授信",
    "marketFunding.rate.current": "当前 / 天",
    "marketFunding.rate.new": "新增 / 天",
    "marketFunding.rate.projected": "下单后 / 天",
    "marketFunding.runway.prepaid": "预存可用时长",
    "marketFunding.runway.total": "总可用时长",
    "marketFunding.runway.unlimited": "无限",
    "marketFunding.coverage": "一天所需保障",
    "marketFunding.coverageSplit": "一天资金构成：预存 {prepaid} + 授信 {credit}。",
    ...
    "marketFunding.topup.maximumPreset": "单笔上限 · {amount}",
    "marketFunding.topup.partialNotice": "这是部分充值；当前报价仍至少缺少 {remaining}。到账后系统会按权威余额刷新报价，可继续充值。",
    "marketFunding.topup.transferLimit": "单笔充值上限：{amount}",
    "marketFunding.topup.custom": "自定义金额（美元）",
    "marketFunding.topup.providerScope": "此预存余额仅归属于当前商家，并由你向该商家租用的付费 Share 和 Client Host 服务共同使用。",
    "marketFunding.topup.refundDisclosure": "未使用的预存会保留在该商家账户中；可在“账户 → 账单”申请退款，需由商家审核。",
    "marketFunding.topup.unavailable": "该商家尚未开通币安充值，请联系商家开通或明确授信。",
    "marketFunding.topup.unavailable.routerDisabled": "当前 Router 已关闭币安充值。",
    "marketFunding.topup.unavailable.routerShadow": "当前 Router 的币安充值仍处于试运行模式，暂不能收款。",
    "marketFunding.topup.unavailable.regionRestricted": "当前 Router 所在区域无法使用币安充值。",
    "marketFunding.topup.unavailable.temporary": "币安充值暂时不可用，请稍后重试。",
    "marketFunding.topup.unavailable.credentialStorage": "当前 Router 无法安全保存币安凭据，因此不能充值。",
    "marketFunding.topup.unavailable.supplier": "该商家尚未启用并验证币安自动收款。",
    "marketFunding.topup.unavailable.settlementRequired": "请先结清该商家的未付账单，再充值预存。",
    ...
    "marketBilling.dispute.autoResolveAt": "自动裁决时间",
    "marketBilling.dispute.escalatedAt": "已升级",
    "marketBilling.dispute.resolvedAt": "裁决时间",
    "marketBilling.dispute.resolution": "裁决结果",
    "marketBilling.creditNotes.title": "抵扣与退款",
    "marketBilling.creditNotes.serviceCredit": "服务抵扣",
    "marketBilling.creditNotes.externalRefund": "线下退款",
    "marketBilling.creditNotes.reference": "参考号：{reference}",
    ...
    "marketBilling.refund.title": "线下退款义务",
    "marketBilling.refund.amount": "退款金额",
    "marketBilling.refund.invoice": "来源账单：{invoice}",
    "marketBilling.refund.due": "请在 {date} 前登记退款",
    "marketBilling.refund.recordedAt": "已于 {date} 登记",
    "marketBilling.refund.reference": "参考号：{reference}",
    "marketBilling.refund.referenceLabel": "线下退款参考号",
    "marketBilling.refund.referenceRequired": "必须填写线下退款参考号。",
    "marketBilling.refund.awaitingSupplier": "等待供应商登记退款",
    "marketBilling.refund.record": "登记退款",
    "marketBilling.refund.privateNotice": "退款参考号和账务详情仅买家、供应商及 Router 管理员可见。",
    "marketBilling.refund.status.pending": "待退款",
    "marketBilling.refund.status.overdue": "已逾期",
    "marketBilling.refund.status.recorded": "已登记",
    ...
    "marketBilling.binance.exactWarning": "请一分不差地转入该金额，小额尾数用于唯一识别本账单。",
    "marketBilling.binance.copyAmount": "复制金额",
    "marketBilling.binance.qrAlt": "币安收款二维码",
    "marketBilling.binance.receiverUid": "收款方币安 UID",
    "marketBilling.binance.copyUid": "复制收款 UID",
    "marketBilling.binance.noteCode": "可选转账备注",
    "marketBilling.binance.copyNote": "复制转账备注",
    "marketBilling.binance.remaining": "剩余时间",
    "marketBilling.binance.statusLabel": "状态",
    "marketBilling.binance.status.pending": "等待付款",
    "marketBilling.binance.status.paid": "付款已确认",
    "marketBilling.binance.status.expired": "付款窗口已过期",
    "marketBilling.binance.status.cancelled": "自动付款已取消",
    "marketBilling.binance.status.review": "需要人工复核",
    "marketBilling.binance.path":
      "币安 App → 支付 → 转账 → 输入 UID → 选择 USDT → 输入精确金额。备注可选填。",
    "marketBilling.binance.degraded":
      "商家账户当前处于降级状态。请勿重复付款；系统会继续重试，也可改用人工付款。",
    "marketBilling.binance.expiredHint":
      "如果已经付款，请勿生成新金额。迟到流水在宽限期内仍受保护并可继续识别。",
    "marketBilling.binance.reviewHint":
      "系统已观测到一笔付款并转入人工复核。请勿再次转账；如需联系商家，仅使用人工确认入口。",
    "marketBilling.binance.lastChecked": "最近检查：{date}",
    "marketBilling.binance.refresh": "生成新金额",
    "marketBilling.binance.cancel": "取消自动付款",
    "marketBilling.binance.manualFallback": "改用人工付款确认",
    "marketBilling.binance.refreshConfirm": "要生成新金额吗？如果已经转出当前金额，请继续等待。",
    "marketBilling.binance.cancelConfirm": "要取消当前自动付款金额吗？之后到账的转账将需要人工复核。",
    "marketBilling.binance.copied": "已复制。",
    "marketBilling.binance.copyFailed": "复制失败，请手动选择并复制。",
    "marketBilling.binance.admin.title": "币安异常对账",
    "marketBilling.binance.admin.hint":
      "处理异常流水。只有正向 USDT 入账，且目标账单属于同一商家付款账户时，才允许人工结算。",
    "marketBilling.binance.admin.unavailable":
      "币安异常对账暂时不可用；市场账务的其他功能仍可正常使用。",
    "marketBilling.binance.admin.openCases": "待处理：{count}",
    "marketBilling.binance.admin.pending": "等待付款：{count}",
    "marketBilling.binance.admin.degraded": "降级账户：{count}",
    "marketBilling.binance.admin.degradedDetails": "需要运维处理的账户",
    "marketBilling.binance.admin.unknownError": "未知轮询错误",
    "marketBilling.binance.admin.failureCount": "连续失败：{count} 次",
    "marketBilling.binance.admin.supplier": "供应商 {supplier}",
    "marketBilling.binance.admin.region": "区域 {region}",
    "marketBilling.binance.admin.degradedSince": "降级起始：{date}",
    "marketBilling.binance.admin.lastSuccess": "最近成功：{date}",
    "marketBilling.binance.admin.nextPoll": "下次轮询：{date}",
    "marketBilling.binance.admin.leaseUntil": "租约截止：{date}",
    "marketBilling.binance.admin.scanProgress": "扫描进度：{cursor} → {target}",
    "marketBilling.binance.admin.order": "币安订单 {order}",
    "marketBilling.binance.admin.counterparty": "稳定付款方 {reference}",
    "marketBilling.binance.admin.payerBinance": "付款方币安 ID {reference}",
    "marketBilling.binance.admin.uid": "UID {uid}",
    ...
    "marketBilling.binance.admin.ignoreConfirm": "确认忽略这笔币安流水吗？该决定会记录在对账审计中。",
    ...
    "marketBilling.dialog.auto-pay": "币安自动付款",
    ...
    "settings.title": "设置",
    "settings.modelPrices.nav": "模型价格",
    "settings.modelPrices.title": "模型价格管理",
    "settings.modelPrices.description": "统一查看所有已知模型、配置 Router 全局价格并保留每一代历史记录。",
    "settings.modelPrices.search": "搜索模型名称或 Key",
    "settings.modelPrices.filter": "筛选模型价格",
    "settings.modelPrices.filter.all": "全部模型",
    "settings.modelPrices.filter.unpriced": "未定价",
    "settings.modelPrices.filter.admin": "管理员覆盖",
    "settings.modelPrices.filter.derived": "内置价格",
    "settings.modelPrices.stat.total": "已知模型",
    "settings.modelPrices.stat.priced": "已定价",
    "settings.modelPrices.stat.unpriced": "未定价",
    "settings.modelPrices.stat.overrides": "管理员覆盖",
    "settings.modelPrices.column.model": "模型",
    "settings.modelPrices.column.status": "状态",
    "settings.modelPrices.column.input": "输入",
    "settings.modelPrices.column.output": "输出",
    "settings.modelPrices.column.cacheRead": "缓存读",
    "settings.modelPrices.column.cacheWrite5m": "缓存写 5m",
    "settings.modelPrices.column.cacheWrite1h": "缓存写 1h",
    "settings.modelPrices.column.effective": "生效时间",
    "settings.modelPrices.column.actions": "操作",
    "settings.modelPrices.source.derived": "内置价格",
    "settings.modelPrices.source.admin": "管理员覆盖",
    "settings.modelPrices.source.unpriced": "未定价",
    "settings.modelPrices.editorTitle": "配置模型价格",
    "settings.modelPrices.add": "新增模型",
    "settings.modelPrices.displayName": "显示名称",
    "settings.modelPrices.history": "价格历史",
    "settings.modelPrices.historyTitle": "价格历史 · {model}",
    "settings.modelPrices.current": "当前生效",
    "settings.modelPrices.restore": "恢复内置价格",
    "settings.modelPrices.restoreConfirm": "确定恢复 {model} 的内置价格吗？管理员价格代际仍会保留在历史中。",
    "settings.modelPrices.empty": "没有符合条件的模型。",
    "settings.modelPrices.resultCount": "共 {count} 个模型",
    "settings.modelPrices.revision": "目录版本",
    "settings.workspaceDescription":
    ...
    "settings.pendingRestart": "有 {count} 项已保存设置正在等待 Router 重启后生效。可在「概览」查看具体项目。",
    "settings.pendingRestartShort": "等待重启",
    "settings.pendingRestartLabel": "等待重启",
    "settings.pendingRestartTitle": "等待重启生效",
    "settings.pendingRestartListDescription":
      "这些值已写入配置，但当前 Router 进程仍使用重启前的运行值。",
    "settings.pendingRestartValues": "已保存：{saved} · 运行中：{runtime}",
    "settings.pendingRestartOpenOverview": "打开概览",
    "settings.persistedSource": "持久化：{source}",
    "settings.runtimeSource": "运行时：{source}",
    "settings.effectiveValue": "当前运行值：{value}",
    "settings.configuredFields": "受管字段",
    "settings.configurationDomains": "配置域",
    "settings.snapshotGenerated": "快照生成时间：{time}",
    "settings.categoriesAria": "设置配置域",
    "settings.overview": "概览",
    "settings.search": "搜索设置",
    "settings.searchPlaceholder": "搜索名称、说明、分组或环境变量 Key",
    "settings.searchResults": "搜索结果",
    "settings.searchResultCount": "匹配 {count} 个字段",
    "settings.fieldCount": "{count} 个字段",
    "settings.changedFieldCount": "{count} 项修改",
    ...
    "settings.mapRevisionConflictAfterSettings":
      "Router 设置已保存，但地图显示已被其他操作修改。已加载最新地图版本并保留你的草稿，请复核后再次保存。",
    "settings.announcementRevisionConflict":
      "公告已被其他操作修改。已加载最新版本并保留你的草稿，请复核后再次保存。",
    "settings.conflictReloadFailed": "保存版本已变化，但重新加载失败：{reason}",
    "settings.savedWithMapError": "Router 设置已保存，但地图显示未保存：{reason}",
    "settings.savedReloadFailed": "设置已保存，但无法重新加载最新快照。继续编辑前请先刷新。",
    "settings.highRisk": "高风险",
    "settings.groupsAria": "设置分组",
    "settings.notifications.system": "系统告警",
    "settings.notifications.business": "业务通知",
    ...
    "settings.alertChannels.title": "渠道验证",
    "settings.alertChannels.description":
      "运维告警和用户通知使用独立的凭据与目标，请分别验证各个渠道。",
    "settings.alertChannels.description.telegram":
      "运维 Telegram 告警和用户通知 Bot 使用独立凭据与目标，请分别验证。",
    "settings.alertChannels.description.bark":
      "运维 Bark 告警和用户 Bark 通知使用独立凭据与目标，请分别验证。",
    "settings.alertChannels.empty": "此渠道暂无验证状态。",
    "settings.emailChannel.title": "邮件验证",
    "settings.emailChannel.description":
      "使用当前 Resend 配置向已登录管理员发送一封测试邮件。",
    "settings.emailChannel.target": "测试收件人：{target}",
    "settings.emailChannel.notConfigured": "请先配置 Resend API Key 和发件人地址并保存，再发送测试。",
    "settings.emailChannel.pendingRestart": "邮件设置已保存，将在 Router 重启后生效。",
    "settings.emailChannel.testSent": "测试邮件已发送至 {target}。",
    ...
    "settings.alertChannels.operator.barkDescription":
      "使用上方独立配置的运维 Bark Server 和固定 Device Key。",
    ...
    "settings.alertChannels.user.barkDescription":
      "使用加密保存的用户 Bark 设备绑定；测试消息发送到当前管理员已绑定的设备。",
    ...
    "settings.alertChannels.diagnostic.title": "连接诊断",
    "settings.alertChannels.diagnostic.details": "技术详情",
    "settings.alertChannels.diagnostic.legacy": "服务返回了网络传输错误，请检查 Router 网络后重试。",
    "settings.alertChannels.diagnostic.bark.configuration": "Bark Server 或设备配置不完整或无效。",
    "settings.alertChannels.diagnostic.bark.api_timeout": "连接已配置的 Bark Server 超时，请检查该 Server 和 Router 主机网络后重试。",
    "settings.alertChannels.diagnostic.bark.network": "Router 无法连接已配置的 Bark Server，请检查 DNS、TLS、出站访问和反向代理。",
    "settings.alertChannels.diagnostic.bark.provider_protocol": "Bark Server 返回了非预期响应，请检查服务版本和反向代理配置。",
    "settings.alertChannels.diagnostic.bark.target_invalid": "Bark 拒绝了该 Device Key，请使用设备当前的完整 Push URL 重新绑定。",
    "settings.alertChannels.diagnostic.bark.authorization": "Bark Server 拒绝了该请求，请检查 Server 和反向代理的访问控制。",
    "settings.alertChannels.diagnostic.bark.rate_limited": "Bark Server 触发频率限制，请等待重试窗口结束后再测试。",
    "settings.alertChannels.diagnostic.bark.server_error": "Bark Server 暂时不可用，Router 将按退避策略重试。",
    "settings.alertChannels.diagnostic.bark.http_error": "Bark Server 返回了非预期 HTTP 错误，请查看技术详情和 Server 日志。",
    "settings.alertChannels.diagnostic.dns_resolution_failed": "Router 无法解析 Telegram API 域名。请检查主机 DNS，可尝试 8.8.8.8 或 1.1.1.1，刷新 DNS 缓存后重试。",
    "settings.alertChannels.diagnostic.api_endpoint_unreachable": "DNS 已返回地址，但 Router 无法与该地址建立 TCP 443 连接。请检查 DNS 结果和出站 TCP 443，可尝试 8.8.8.8 或 1.1.1.1。",
    "settings.alertChannels.diagnostic.api_timeout": "连接 Telegram API 超时。请检查 Router 主机的 DNS 结果和出站 TCP 443。",
    "settings.alertChannels.diagnostic.tls_handshake_failed": "TCP 已连接，但 TLS 握手失败。请检查系统时间、CA 证书和 TLS 拦截。",
    "settings.alertChannels.diagnostic.invalid_token": "Telegram Bot Token 无效或已撤销，请重新生成 Token 并保存。",
    "settings.alertChannels.diagnostic.polling_conflict": "另一个进程或 webhook 正在消费此 Bot，请停止其他消费者或切换 Bot 模式。",
    "settings.alertChannels.diagnostic.rate_limited": "Telegram 触发频率限制，请等待指定时间后重试。",
    "settings.alertChannels.diagnostic.chat_unreachable": "Telegram 无法投递到该聊天，用户可能屏蔽了 Bot 或聊天已不存在。",
    "settings.alertChannels.diagnostic.http_error": "Telegram 返回了未预期的 HTTP 错误，请查看技术详情后重试。",
    "settings.alertChannels.diagnostic.configuration": "Telegram Bot 配置不完整或无效。",
    "settings.alertChannels.diagnostic.request_error": "无法构造 Telegram 请求，请检查 Router 配置。",
    "settings.alertChannels.diagnostic.response_read_failed": "Router 无法读取 Telegram 响应，请检查网络后重试。",
    "settings.alertChannels.diagnostic.transport_error": "Telegram 网络传输失败，请检查 Router 主机网络后重试。",
    "settings.alertChannels.diagnostic.resolved": "解析地址：{addresses}",
    "settings.alertChannels.diagnostic.reachable": "可达地址：{addresses}",
    "settings.alertChannels.diagnostic.dnsError": "DNS 详情：{error}",
    "operations.title": "运维",
    "operations.description": "查看并控制 Router 运行服务、日志、投递队列和管理员操作记录。",
    "operations.navigation": "运维分区",
    "operations.service": "服务与版本",
    "operations.logs": "Router 日志",
    "operations.deliveries": "通知中心",
    "operations.audit": "管理员审计",
    "operations.audit.title": "管理员审计",
    "operations.audit.description": "此 Router 最近记录的高权限操作。",
    "operations.audit.time": "时间",
    "operations.audit.actor": "操作者",
    "operations.audit.action": "操作",
    "operations.audit.ip": "来源 IP",
    "operations.audit.details": "详情",
    "operations.audit.empty": "暂无管理员操作记录。",
    "metrics.title": "Metrics",
    ...
    "metrics.clock.offset": "时钟偏差",
    "metrics.clock.ntp": "NTP",
    "metrics.clock.quorum": "HTTPS 时间源仲裁",
    "metrics.clock.confidence": "可信度",
    "metrics.clock.lastSuccess": "最近成功探测",
    "metrics.clock.rejections": "Ingress 拒绝（过期 / 未来 / 协议）",
    "metrics.clock.synchronized": "已同步",
    "metrics.clock.unsynchronized": "未同步",
    "metrics.clock.unknown": "未知",
    "metrics.clock.sourceFailed": "探测失败",
    "metrics.clock.disabled": "时钟监控已关闭",
    "metrics.clock.noData": "所选时间范围内没有有效的时钟仲裁采样",
    "metrics.clock.thresholdHint": "预警阈值：慢 15 秒 / 快 2 秒",
    "metrics.clock.status.healthy": "健康",
    "metrics.clock.status.warning": "警告",
    "metrics.clock.status.critical": "严重",
    "metrics.clock.status.degraded": "降级",
    "metrics.clock.status.disabled": "已关闭",
    "metrics.clock.status.unknown": "未知",
    "metrics.tab.overview": "概览",
    "metrics.tab.host": "主机",
    "metrics.tab.router": "Router",
    "metrics.tab.clients": "Clients",
    "metrics.tab.llm": "LLM",
    "metrics.tab.alerts": "告警",
    "metrics.tab.events": "事件",
    "metrics.clients.total": "Client 总数",
    "metrics.clients.monitored": "已监控 {count} 个",
    "metrics.clients.online": "在线",
    "metrics.clients.onlineDesc": "可信签名心跳处于有效状态",
    "metrics.clients.offline": "离线",
    "metrics.clients.offlineDesc": "已由 presence 状态机确认",
    "metrics.clients.recovering": "恢复中",
    "metrics.clients.recoveringDesc": "正在等待心跳持续稳定",
    ...
    "metrics.clients.lastSeen": "最近可信在线时间",
    "metrics.clients.offlineSince": "离线开始时间",
    "metrics.clients.episode": "离线 Episode",
    "metrics.clients.notMonitored": "未监控",
    "metrics.clients.status.online": "在线",
    "metrics.clients.status.recovering": "恢复中",
    "metrics.clients.status.offline": "离线",
    "metrics.clients.status.unknown": "未知",
    "metrics.alerts.active": "活跃事故",
    "metrics.alerts.activeDesc": "触发中、已确认或已静默",
    "metrics.alerts.critical": "严重事故",
    "metrics.alerts.criticalDesc": "需要立即处理的活跃事故",
    "metrics.alerts.failedDeliveries": "失败投递",
    "metrics.alerts.failedDeliveriesDesc": "等待重试、最终失败或渠道禁用的投递",
    "metrics.alerts.resolved": "已恢复历史",
    "metrics.alerts.historyDesc": "保留期内的全部已恢复事故",
    "metrics.alerts.channels": "通知渠道",
    ...
    "metrics.alerts.silence6h": "静默 6 小时",
    "metrics.alerts.silence24h": "静默 24 小时",
    "metrics.alerts.silence7d": "静默 7 天",
    "metrics.alerts.noActive": "当前没有活跃事故。",
    "metrics.alerts.acknowledge": "确认",
    "metrics.alerts.silence": "静默",
    "metrics.alerts.resume": "恢复通知",
    "metrics.alerts.started": "开始于 {time}",
    ...
    "metrics.alerts.updated": "更新时间",
    "metrics.alerts.error": "最近错误",
    "metrics.alerts.retryQueued": "投递已重新进入队列。",
    "metrics.alerts.action.acknowledge.success": "事故已确认。",
    "metrics.alerts.action.silence.success": "事故已静默。",
    "metrics.alerts.action.resume.success": "事故通知已恢复。",
    "metrics.alerts.severity.info": "信息",
    "metrics.alerts.severity.warning": "警告",
    "metrics.alerts.severity.critical": "严重",
    "metrics.alerts.status.firing": "触发中",
    "metrics.alerts.status.acknowledged": "已确认",
    "metrics.alerts.status.silenced": "已静默",
    "metrics.alerts.status.resolved": "已恢复",
    "metrics.alerts.delivery.pending": "等待中",
    "metrics.alerts.delivery.claimed": "发送中",
    "metrics.alerts.delivery.retry": "等待重试",
    "metrics.alerts.delivery.sent": "已发送",
    "metrics.alerts.delivery.dead_letter": "最终失败",
    "metrics.alerts.delivery.suppressed_disabled": "渠道已禁用",
    "metrics.alerts.delivery.superseded": "已被更新流转取代",
    ...
    "metrics.detail.validSamples": "{count} 个有效样本",
    "metrics.chart.systemRisk": "系统风险趋势",
    "metrics.chart.hostPerformance": "主机性能",
    "metrics.chart.clockOffset": "Router 时钟偏差",
    ...
    "metrics.chart.ttftTrend": "TTFT 趋势",
    "metrics.chart.tpsTrend": "TPS 趋势",
    "metrics.series.rateLimited": "限流 (429)",
    "metrics.series.concurrencyLimited": "并发已满 (409)",
    "metrics.series.average": "平均值",
    ...
    "metrics.panel.clockHealth": "时钟健康",
    "metrics.panel.counters": "路由生命周期计数",
    "metrics.shareControl.title": "Share 控制队列",
    "metrics.shareControl.description": "查看待投递、投递中以及自动重试耗尽的撤销操作。",
    "metrics.shareControl.pending": "待投递",
    "metrics.shareControl.dispatched": "投递中",
    "metrics.shareControl.deadLettered": "死信",
    "metrics.shareControl.attempts": "已尝试 {count} 次",
    "metrics.shareControl.requeue": "重新排队撤销",
    "metrics.shareControl.manualOnly": "需要人工排查",
    "metrics.shareControl.empty": "当前没有 Share 控制死信。",
    "metrics.shareControl.requeued": "Share 撤销操作已重新排队。",
    "metrics.panel.topConsumers": "用量排行",
    "metrics.panel.sharePerformance": "Share 性能",
    "metrics.panel.sharePerformanceDesc":
      "仅统计成功且完整结束的流式请求；TTFT 与 output token TPS 使用各自有效样本。",
    ...
    "metrics.counter.pendingChannelOpens": "等待建立的 SSH 通道",
    "metrics.counter.channelOpenStarted": "SSH 通道建立请求数",
    "metrics.counter.channelOpenSucceeded": "SSH 通道建立成功数",
    "metrics.counter.channelOpenExplicitFailures": "Client 拒绝 SSH 通道数",
    "metrics.counter.channelOpenTimeouts": "SSH 通道建立超时数",
    "metrics.counter.channelOpenSessionErrors": "SSH 通道建立会话错误数",
    "metrics.counter.channelOpenCancelled": "SSH 通道建立取消数",
    "metrics.counter.activeBridges": "活动 SSH bridge",
    "metrics.counter.bridgeCreated": "SSH bridge 创建数",
    "metrics.counter.bridgeCompleted": "SSH bridge 完成数",
    "metrics.counter.bridgeCancelled": "SSH bridge 取消数",
    "metrics.counter.bridgeWriteStalls": "SSH bridge 写阻塞数",
    "metrics.counter.bridgeHalfCloseIdle": "SSH bridge 半关闭空闲超时数",
    "metrics.counter.bridgeIoErrors": "SSH bridge I/O 错误数",
    "metrics.counter.forwardCapacityRejected": "SSH 转发连接容量拒绝数",
    "metrics.counter.shareActiveRequests": "Share 活跃请求",
    "metrics.counter.shareOldestInflightAge": "最老 Share 请求时长（秒）",
    "metrics.counter.shareOldestProgressAge": "最老 Share 进度停滞（秒）",
    "metrics.counter.shareWatchdogReleases": "看门狗强制回收 Share 请求",
    "metrics.counter.shareManualReleases": "手动回收 Share 请求",
    "metrics.counter.requestBodyTimeouts": "请求体读取超时",
    "metrics.counter.responseHeaderTimeouts": "响应头等待超时",
    "metrics.counter.downstreamStallTimeouts": "下游阻塞超时",
    "metrics.counter.requestHardTimeouts": "请求硬时限超时",
    "metrics.counter.streamSemanticTerminals": "协议终止流",
    "metrics.counter.streamFirstEventTimeouts": "首事件超时",
    "metrics.counter.streamIdleTimeouts": "流空闲超时",
    "metrics.counter.streamParserOverflows": "流解析缓冲溢出",
    "metrics.counter.streamUpstreamErrors": "上游流错误",
    ...
    "metrics.header.p95": "P95",
    "metrics.header.share": "Share",
    "metrics.header.samples": "TTFT / TPS 样本",
    "metrics.header.lastRequest": "最近请求",
    ...
    "notifications.description":
      "统一查看 Bark、Telegram 与邮件的运维告警和用户通知历史。",
    "notifications.search": "搜索事件、目标或错误",
    "notifications.allSources": "全部来源",
    "notifications.operatorAlerts": "运维告警",
    "notifications.userNotifications": "用户通知",
    "notifications.allChannels": "全部渠道",
    "notifications.allStatuses": "全部状态",
    "notifications.failedRetrying": "失败 / 重试中",
    "notifications.suppressed": "已抑制",
    "notifications.messagePreview": "消息预览",
    "notifications.operatorTarget": "运维渠道",
    "notifications.pageSummary": "{count} 条记录 · 第 {page} / {pages} 页",
    ...
    "notifications.empty": "没有符合条件的通知投递。",
    ...
    "notifications.status.cancelledChannelChanged": "渠道变更后已取消",
    ...
    "version.upgradeFailed": "升级失败，二进制未被替换。详情见升级日志。",
    "version.upgradeFailedWith": "升级失败，二进制未被替换：{reason}",
    "dashboard.chat": "聊一聊",
    "chat.open": "打开聊天室",
    "chat.close": "关闭聊天室",
    "chat.title": "聊天室",
    ...
    "chat.event.billingFundingRunwayWarning":
      "该商家的总资金可用时长已不足 3 天，请打开账单页充值预存。",
    "chat.event.billingFundingRunwayCritical":
      "该商家的总资金可用时长已不足 1 天，请立即充值预存以避免服务中断。",
    "chat.event.billingFundingRunwayRecovered":
      "该商家的低续航资金提醒已解除。",
    "chat.event.billingAccountClosing":
    ...
    "chat.detail.kind": "类型",
    "chat.detail.lastHeartbeatAt": "最后一次可信心跳",
    ...
    "dashboard.mine": "我的",
    "modelHub.title": "模型中枢",
    "modelHub.optional": "统一入口 · 可选配置",
    "modelHub.endpoint": "统一入口",
    "modelHub.apiKey": "API Key",
    "modelHub.routes": "模型路由",
    "modelHub.addRoute": "添加模型",
    "modelHub.app": "协议",
    "modelHub.protocol.claude": "Anthropic",
    "modelHub.protocol.codex": "OpenAI",
    "modelHub.protocol.gemini": "Gemini",
    "modelHub.status.empty": "未配置",
    "modelHub.status.passthrough": "纯透传",
    "modelHub.status.exact": "{count} 个模型",
    "modelHub.status.mixed": "透传 + {count} 个模型",
    "modelHub.status.attention": "需处理",
    "modelHub.emptyProtocol": "未配置。打统一入口的此类请求不会转到任何 Share。",
    "modelHub.passthrough": "透传（其余模型）",
    "modelHub.passthroughUnset": "未设置",
    "modelHub.passthroughHint.none": "该协议任意模型名都转到此 Share，模型名原样转发。",
    "modelHub.passthroughHint.mixed": "只有下面没写到的模型才走这里，模型名原样转发。",
    "modelHub.exactModels": "特定模型",
    "modelHub.exactEmpty": "暂无",
    "modelHub.listMode.passthrough": "列表：转发此 Share（与直连相同）。",
    "modelHub.listMode.mixed": "列表：由下方精确名合成，不会原样返回透传 Share 的目录。",
    "modelHub.listMode.exact": "列表：仅下方名称。其它模型失败。",
    "modelHub.listMode.empty": "该协议暂不对外公布任何模型。",
    "modelHub.expandRoutes": "编辑路由",
    "modelHub.collapseRoutes": "收起路由",
    "modelHub.unsavedTitle": "放弃未保存的路由？",
    "modelHub.unsavedDescription": "收起编辑器会重新加载上次保存的 Anthropic / OpenAI / Gemini 路由。",
    "modelHub.unsavedDiscard": "放弃",
    "modelHub.summary.empty": "未配置",
    "modelHub.model": "请求模型",
    "modelHub.modelPlaceholder": "精确模型名称",
    "modelHub.targetShare": "目标 Share",
    "modelHub.removeRoute": "删除路由",
    "modelHub.empty": "尚未配置统一模型路由。",
    "modelHub.validationRequired": "每条路由都必须填写精确模型名称并选择目标 Share。",
    "modelHub.validationDuplicate": "同一协议和模型只能对应一个目标 Share。",
    "modelHub.validationTooMany": "最多可配置 100 条模型路由。",
    "modelHub.validationPattern": "`*` 表示路由全部模型；不支持 `gpt-*` 这类部分通配写法。",
    "modelHub.addWildcard": "全部模型",
    "modelHub.addWildcardHint": "将某个协议的全部模型路由到一个 Share，每个协议至多一条。",
    "modelHub.wildcardLabel": "全部模型（透传）",
    "modelHub.wildcardHint": "未被上方精确路由命中的模型都会转发到此 Share，模型名原样透传。",
    "modelHub.wildcardPassthroughHint": "该协议下只有这一条路由，统一 API 就是此 Share 的纯转发层：模型列表直接来自该 Share，请求行为与直连该 Share 完全一致。",
    "modelHub.targetUnavailable": "目标不可用或已无权限",
    "modelHub.resetKeyImpact": "重置后，当前 Key 会立即无法用于统一入口及所有 Share 直连入口。",
    "modelHub.directEndpoint": "直连",
    "modelHub.modelPending": "待填写模型",
    "modelHub.noRoutesForShare": "暂无统一路由",
    "modelHub.addRouteForShare": "为此 Share 新增模型路由",
    "modelHub.mapModel": "映射",
    "modelHub.protocolTabs": "协议路由",
    "modelHub.configTitle": "路由",
    "modelHub.test.title": "测试",
    "modelHub.test.run": "运行测试",
    "modelHub.test.running": "测试中…",
    "modelHub.test.saveFirst": "请先保存路由。测试走的是上次保存的配置，不是当前草稿。",
    "modelHub.test.needModel": "请填写可调用的模型名。`*` 是路由规则，不能直接当模型名调用。",
    "modelHub.test.needRoute": "先配置透传或至少一个模型并保存，才能测试。",
    "modelHub.test.wildcardHint": "透传会原样转发你填写的模型名，请用该 Share 实际接受的名称。",
    "modelHub.test.matchedExact": "命中精确路由",
    "modelHub.test.matchedPassthrough": "命中透传",
    "modelHub.test.model": "测试模型",
    "modelHub.test.curl": "curl",
    "modelHub.test.response": "响应",
    "modelHub.test.headers": "响应头",
    "modelHub.test.body": "响应体",
    "modelHub.test.bodyTruncated": "响应体已截断",
    "modelHub.test.durationMs": "{ms} 毫秒",
    "modelHub.test.networkError": "测试失败：{message}",
    "modelHub.test.empty": "该协议还没有已保存的路由，无法测试。",
    "modelHub.test.target": "目标 Share",
    "dashboard.all": "全部",
    ...
    "dashboard.totalThroughput": "TTFT/TPS",
    "dashboard.ttftTpsHint":
      "最近 10 次请求 · TTFT 有效样本：{ttftSamples} · TPS 有效样本：{tpsSamples}",
    "dashboard.region": "地区",
    ...
    "dashboard.connectDialog.credentials": "凭据",
    "dashboard.connectDialog.baseUrl": "Base URL",
    "dashboard.connectDialog.apiKey": "API Key",
    ...
    "dashboard.connectDialog.test.section": "端到端连接测试",
    ...
    "dashboard.connectDialog.test.policyPassthrough":
      "当前 API 会将模型名透传给供应商 {provider}；请使用该供应商支持的模型名。",
    "dashboard.connectDialog.test.policySingle":
      "无论请求使用什么模型名，都会映射到固定上游模型 {model}。",
    "dashboard.connectDialog.test.policyUnknown": "模型路由遵循已绑定供应商的配置。",
    "dashboard.connectDialog.test.providerUnknown": "已绑定供应商",
    "dashboard.connectDialog.test.testModel": "测试模型",
    "dashboard.connectDialog.test.curlLabel": "curl",
    "dashboard.connectDialog.test.responseToggle": "响应",
    "dashboard.connectDialog.test.durationMs": "{ms} ms",
    ...
    "dashboard.healthCalendar.inactiveNow": "当前不在模型监测资格期",
    "dashboard.healthCalendar.sharedProbe": "共享上游探针",
    "dashboard.healthCalendar.legacyEvidence": "历史中包含旧版证据，仅供参考。",
    "dashboard.healthCalendar.unavailable": "暂时无法获取上游模型可用性历史。",
    "dashboard.healthCalendar.day":
      "{date}：可用率 {rate}%（成功 {successful}/{expected}；已观测 {observed}；确认的上游侧失败 {upstreamFailures}；监测缺口 {gaps}；覆盖率 {coverage}%）",
    "dashboard.healthCalendar.inactiveDay": "{date}：不在监测资格期",
    "dashboard.healthCalendar.mixedEpoch": "当天探针配置发生过切换。",
    "dashboard.healthCalendar.legacyDay": "当天包含旧版证据。",
    "dashboard.healthCalendar.lower": "较低",
    "dashboard.healthCalendar.higher": "较高",
    "dashboard.clientOnlineCalendar.title": "Client 在线",
    "dashboard.clientOnlineCalendar.hint": "自注册起按隧道探测统计。",
    "dashboard.clientOnlineCalendar.schedule": "已观测 {days} 天 · {timezone}",
    "dashboard.clientOnlineCalendar.unavailable": "暂时无法获取 Client 在线历史。",
    "dashboard.clientOnlineCalendar.day":
      "{date}：在线率 {rate}%（在线 {online}/{observed} 观测分钟）",
    "dashboard.clientOnlineCalendar.unobservedDay": "{date}：当天无隧道探测",
    "dashboard.noShare": "无 share",
    "dashboard.noClients": "暂无 clients",
    "dashboard.noMyClients": "暂无你拥有或通过 ShareTo 使用的 Client",
    "dashboard.noMyShares": "暂无你拥有、通过 ShareTo 使用或已写入路由的 Share",
    ...
    "dashboard.operationalQuality": "运行",
    "dashboard.warningCount": "{count} 个告警",
    "dashboard.noWarnings": "无告警",
    "dashboard.noEnabledShares": "无启用 Share",
    "dashboard.availability": "可用率",
    "dashboard.issues": "项异常",
    "dashboard.searchClients": "搜索 client、share",
    "dashboard.searchShares": "搜索 Share、子域、供应商",
    "dashboard.filter": "筛选",
    ...
    "dashboard.modelPolicyPassthrough": "透传",
    ...
    "dashboard.shares": "Shares",
    "dashboard.sharesAvailableDetail":
      "服务可用：{available}/{total}；路由在线：{routeOnline}/{total}；有运行告警的 Share：{warnings}/{total}。",
    "dashboard.appType": "App",
    "dashboard.installation": "Installation",
    ...
    "dashboard.videoJobs": "视频",
    "dashboard.connectDialog.test.operationText": "文字",
    "dashboard.connectDialog.test.operationImageGeneration": "生成图片",
    "dashboard.connectDialog.test.operationImageEdit": "编辑图片",
    "dashboard.connectDialog.test.operationVideoGeneration": "生成视频",
    ...
    "dashboard.shareEdit.descriptionPlaceholder": "Share 描述文字",
    "dashboard.shareEdit.section.market": "应用接口",
    ...
    "dashboard.shareRecentErrors.status": "HTTP {code}",
    "dashboard.shareRecentErrors.caller": "调用方",
    "dashboard.shareRecentErrors.anonymous": "无调用方邮箱",
    "dashboard.shareRecentErrors.truncated": "正文已在 8 KiB 处截断",
    "dashboard.shareRecentErrors.time": "时间",
    "dashboard.shareRecentErrors.request": "请求",
    "dashboard.shareRecentErrors.reason.buffered": "已捕获响应正文",
    "dashboard.shareRecentErrors.reason.sse_not_buffered": "流式响应，未缓存正文",
    "dashboard.shareRecentErrors.reason.empty_body": "响应正文为空",
    "dashboard.shareRecentErrors.reason.read_failed": "响应正文未能完整读取",
    "dashboard.shareRecentErrors.reason.router_local": "Router 本地错误",
    ...
    "dashboard.userLimit.title": "授权用户与配额",
    "dashboard.userLimit.hint":
    ...
    "dashboard.userLimit.byModel.coverage":
      "已定价覆盖 {coverage}% · {estimated}% 请求为估算",
    "dashboard.userLimit.price.configure": "配置价格",
    "dashboard.userLimit.price.edit": "编辑价格",
    "dashboard.userLimit.price.title": "配置模型价格",
    "dashboard.userLimit.price.editTitle": "编辑模型价格",
    "dashboard.userLimit.price.globalHint": "该价格将应用于 Router 中此模型的所有 Share。",
    "dashboard.userLimit.price.input": "输入 · USD / 百万 Token",
    "dashboard.userLimit.price.output": "输出 · USD / 百万 Token",
    "dashboard.userLimit.price.cacheRead": "缓存读 · USD / 百万 Token",
    "dashboard.userLimit.price.cacheWrite5m": "缓存写 5m · USD / 百万 Token",
    "dashboard.userLimit.price.cacheWrite1h": "缓存写 1h · USD / 百万 Token（可选）",
    "dashboard.userLimit.price.calculationDetails": "计算详情",
    ...
    "dashboard.hint.freeAccess":
      "默认关闭。开启后，任意已登录 Router 用户都可使用自己的 Router API Token 调用；这不是匿名公开访问。",
    "dashboard.hint.freeAccessUserOverrides":
      "下方授权用户仍可用于设置个人配额覆盖；公开免费开启时，它们不是准入名单。",
    ...
    "dashboard.emailTokenUsageSubtitle": "全部 App · {total} Tokens",
