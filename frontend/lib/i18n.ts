...
export const messages = {
  en: {
    ...
    "clientMarket.offerHint": "Leave the price empty for free forever. Paid Hosts use this fixed daily rate and unified postpaid billing.",
    "clientMarket.offerInvalid": "Enter a valid daily price with at most two decimal places, or leave it empty for free forever.",
    ...
    "clientMarket.makeFreeHint": "Clear the price to make the Host free forever.",
    ...
    "clientMarket.offerRequiresBilling": "Paid Host offers require payment details and payment grace for the selected currency.",
    ...
    "clientMarket.importVersionRequired": "Each line must be ip:port with optional |note|dailyPriceMinor|currency|fingerprint.",
    ...
    "clientMarket.transferFormatHint": "One host per line: ip:port|note|dailyPriceMinor|currency|fingerprint. Currency is CNY or USD; only ip:port is required. Lines starting with # are ignored.",
    "clientMarket.importPlaceholder": "203.0.113.9:22\n203.0.113.10:22|lab note|500|USD",
    ...
    "marketAccess.mode.whitelist": "Whitelist",
    "marketAccess.mode.blacklist": "Blacklist",
    "marketAccess.policySaved": "Access policy saved.",
    "marketAccess.blacklistBannerTitle": "Blacklist mode allows access by default",
    "marketAccess.blacklistBanner": "Users you have not explicitly denied may rent free products. Paid rentals also use the public limited credit below. Only use this mode when you accept the additional exposure.",
    "marketAccess.blacklistConfirmTitle": "Enable blacklist mode?",
    "marketAccess.blacklistConfirmDescription": "This allows users without a private trust relationship to rent your free products. Paid rentals become available to them when public credit is enabled.",
    ...
    "marketAccess.empty": "No buyer relationships yet.",
    ...
    "marketAccess.limitMajor": "Limit (major units)",
    ...
    "marketBilling.payables.hint": "Each supplier and currency has one shared balance across all rented Share seats and Client Hosts.",
  ...
  "zh-CN": {
    ...
    "clientMarket.offerHint": "价格留空表示免费永久；收费 Host 使用固定每日费率和统一后付费账务。",
    "clientMarket.offerInvalid": "请输入最多两位小数的有效每日费用，或留空表示免费永久。",
    ...
    "clientMarket.makeFreeHint": "清空价格可将 Host 改为免费永久。",
    ...
    "clientMarket.offerRequiresBilling": "发布付费 Host 前，必须配置收款信息以及所选币种的付款宽限。",
    ...
    "clientMarket.importVersionRequired": "每行格式为 ip:port，可选 |备注|每日价格（最小货币单位）|币种|指纹。",
    ...
    "clientMarket.transferFormatHint": "每行一台：ip:port|备注|每日价格（最小货币单位）|币种|指纹。币种为 CNY 或 USD；仅 ip:port 必填；以 # 开头的行为注释。",
    "clientMarket.importPlaceholder": "203.0.113.9:22\n203.0.113.10:22|机房备注|500|CNY",
    ...
    "marketAccess.mode.whitelist": "白名单",
    "marketAccess.mode.blacklist": "黑名单",
    "marketAccess.policySaved": "准入策略已保存。",
    "marketAccess.blacklistBannerTitle": "黑名单模式默认允许访问",
    "marketAccess.blacklistBanner": "未被明确拒绝的用户可以租用免费产品；付费租用还会使用下方公共有限额度。仅在你接受额外风险敞口时使用此模式。",
    "marketAccess.blacklistConfirmTitle": "启用黑名单模式？",
    "marketAccess.blacklistConfirmDescription": "没有私下建立信任关系的用户也可租用你的免费产品；启用公共额度后，他们还可租用付费产品。",
    ...
    "marketAccess.limitMajor": "额度（主币单位）",
    ...
    "marketBilling.payables.hint": "同一供应商和币种下，所有 Share 与 Client Host 共用一个赊账余额。",
