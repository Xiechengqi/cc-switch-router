...
export const messages = {
  en: {
    ...
    "shareMarket.blockAndRevoke": "Reclaim and block",
    ...
    "shareMarket.declarePaid": "Payment completed",
    "shareMarket.goPay": "Go to payment",
    "shareMarket.paymentCountdown": "Due in {countdown}",
    "shareMarket.paymentDetails": "Payment details",
    "shareMarket.paymentPreparing": "Access is being confirmed. Payment confirmation will be enabled as soon as the invoice is ready.",
    "shareMarket.paymentDeadline": "Declare by {time}",
    "shareMarket.trialEnds": "Trial ends {time}",
    "shareMarket.periodEnds": "Paid through {time}",
    "shareMarket.confirmPaid": "I have paid the Share owner using the details shown.",
    "shareMarket.unblock": "Unblock",
    "shareMarket.blocks": "User blacklist",
    "shareMarket.blocksHint": "Blocked accounts cannot rent your Share Market seats until you unblock them.",
    "shareMarket.noBlocks": "No users are on your blacklist.",
    "shareMarket.blocksCol.email": "Email",
    "shareMarket.blocksCol.reason": "Reason",
    "shareMarket.blocksCol.since": "Since",
    "shareMarket.blockedAddedToast": "{email} added to blacklist",
    "shareMarket.blockedAddedCountToast": "Added {count} users to blacklist",
    "shareMarket.unblockedToast": "{email} removed from blacklist",
    "market.userBlacklist": "User blacklist",
    "market.blacklistUnblock": "Unblock",
    "market.blacklistCol.email": "Email",
    "market.blacklistCol.reason": "Reason",
    "market.blacklistCol.since": "Since",
    "market.blacklistAddTitle": "Add to blacklist",
    "market.blacklistAddHint": "Enter one or more account emails, separated by commas, spaces, or new lines.",
    "market.blacklistAddPlaceholder": "user@example.com",
    "market.blacklistAddCount": "{count} email(s) ready",
    "shareMarket.noPaymentMethods": "The owner has no payment details available. Do not declare payment until they are updated.",
    "shareMarket.ownerRevokeReason": "Reclaimed by the Share owner",
    "shareMarket.subscription.grantPending": "Grant pending",
    "shareMarket.subscription.activeFree": "Free access",
    "shareMarket.subscription.trialPaymentDue": "Trial · payment due",
    "shareMarket.subscription.activePaid": "Paid",
    "shareMarket.subscription.renewalDue": "Renewal due",
    ...
    "shareMarket.confirm.blockTitle": "Reclaim and block this renter?",
    "shareMarket.confirm.blockDescription": "Access for {email} will be removed and this account cannot rent your listings again until unblocked.",
    ...
    "shareMarket.error.billingPeriod": "Billing period must be an integer between 1 and 365.",
    "shareMarket.error.currency": "Currency must be CNY or USD.",
    ...
    "shareMarket.dialog.amount": "Price",
    "shareMarket.dialog.currency": "Currency",
    "shareMarket.dialog.billingCount": "Every",
    "shareMarket.dialog.billingUnit": "Unit",
    "shareMarket.dialog.day": "day(s)",
    "shareMarket.dialog.week": "week(s)",
    "shareMarket.dialog.month": "month(s)",
    ...
    "account.clientHint": "Monitor Market rentals as renter or Host Provider. Pay, renew, and release only in Client Market.",
    "account.shareHint": "Monitor Share Market seat rentals as User or Provider. Rent, pay, and reclaim only in Share Market.",
    ...
    "account.client.deadline": "Payment deadline",
    "account.client.noDeadline": "—",
    ...
    "account.client.status.paymentDue": "Payment due",
    ...
    "account.rentalsHint": "Pay, renew, or release Clients you rent from Host Providers.",
    "account.paymentDetails": "Payment details",
    "account.visibilityHint": "Payment methods and contact info appear in Market contact dialogs for signed-in users and in renter payment dialogs.",
    "account.contact.title": "Contact info",
    "account.contact.hint": "Shown in payment dialogs and on Market so renters can reach you.",
    ...
    "account.blockReason.paymentNotReceived": "Payment not received",
    ...
    "clientMarket.rentalPrice": "Rental price",
    "clientMarket.rentalPeriod": "Rental period (days)",
    "clientMarket.rentalCurrency": "Currency",
    "clientMarket.priceUsd": "Price",
    "clientMarket.currency": "Currency",
    "clientMarket.periodDays": "Period (days)",
    "clientMarket.free": "Free",
    "clientMarket.forever": "Forever",
    "clientMarket.offerHint": "Leave both empty for a free, permanent allocation. Paid periods must be at least 4 days.",
    "clientMarket.offerInvalid": "Enter both a valid USD price and rental period, or leave both empty for free forever.",
    "clientMarket.offerRange": "Paid Hosts require $0.01-$1,000,000.00 and a 4-3650 day rental period.",
    ...
    "clientMarket.editOfferHint": "Changes apply immediately to unpaid invoices. Existing paid periods keep their current end date. The Client owner is notified by email.",
    "clientMarket.makeFreeHint": "Clear both fields to make the Host free forever.",
    ...
    "clientMarket.unpaidCleanup": "Not paid · release now",
    "clientMarket.unpaidCleanupConfirmTitle": "Release this unpaid Client?",
    "clientMarket.unpaidCleanupConfirmDesc": "Remove the Client on {host}. Use this only after checking that payment was not received.",
    "clientMarket.unpaidBlockCheckbox": "Also block this user ({email}) from renting your Hosts again",
    "clientMarket.blockedOwners": "User blacklist",
    "clientMarket.blockedHint": "Blocked accounts cannot allocate your Hosts. Add manually, or opt in when releasing unpaid Clients.",
    "clientMarket.blockEmailPlaceholder": "client@example.com",
    "clientMarket.blockAdd": "Add",
    "clientMarket.blockedAddedToast": "{email} is blocked from your Hosts",
    "clientMarket.blockedAddedCountToast": "Blocked {count} users from your Hosts",
    "clientMarket.noneBlocked": "No users are on your blacklist.",
    "clientMarket.blockedCol.email": "Email",
    "clientMarket.blockedCol.reason": "Reason",
    "clientMarket.blockedCol.since": "Since",
    "clientMarket.blockReason.manual": "Manual",
    ...
    "clientMarket.nextBillCountdown": "Bill in {countdown}",
    "clientMarket.paymentDueCountdown": "Due in {countdown}",
    ...
    "clientMarket.importVersionRequired": "Each line must be ip:port with optional |note|priceCents|periodDays|fingerprint.",
    ...
    "clientMarket.transferFormatHint": "One host per line: ip:port|note|priceCents|periodDays|fingerprint. Only ip:port is required. Lines starting with # are ignored.",
    "clientMarket.importPlaceholder": "203.0.113.9:22\n203.0.113.10:22|lab note|500|30",
    ...
    "clientMarket.observedPeriodRange": "period {range} days",
    ...
    "clientMarket.activityPaid": "paid {count}",
    ...
    "createClient.freeOnlyHint": "This flow only creates from free Hosts. They may be unstable or reclaimed anytime — pick a paid Host in Client Market for stability.",
    "createClient.freeOnlyHintLink": "Client Market",
    ...
    "billing.declaredToast": "Payment declaration recorded. The Host Provider has been notified.",
    "billing.releaseStartedToast": "Client release started. Its tunnel has been disabled.",
    "billing.paymentDue": "Payment due",
    "billing.goPay": "Pay now",
    "billing.billSoon": "Bill in {countdown}",
    "billing.billSoonCompact": "Bill {countdown}",
    "billing.deadlineLabel": "Due in {countdown}",
    "billing.deadlineCompact": "Due {countdown}",
    "billing.paidThroughHint": "Paid through {date}",
    "billing.nextBillHint": "Next bill in {countdown}",
    "billing.timeRemaining": "Time remaining",
    "billing.threeDays": "3 days",
    "billing.releaseNow": "Release now",
    "billing.creationBlocked": "New Client creation remains blocked until payment is declared or this Client is released.",
    "billing.releasing": "Releasing Client and returning the Host to its Provider...",
    "billing.releaseFailed": "Release failed — the remote host may still be running cc-switch-server. Retry cleanup.",
    "billing.manageInMarket": "Manage in Market",
    "billing.retryRelease": "Retry release",
    "billing.nextWindow": "Next billing window in {countdown}; paid through {date}",
    "billing.payProvider": "Pay Host Provider",
    "billing.provider": "Provider",
    "billing.currentOffer": "Current offer",
    "billing.declareBefore": "Declare before",
    "billing.providerPaymentDetails": "Provider payment details",
    "billing.noPaymentDetails": "The Provider has not configured online payment details.",
    "billing.emailOffline": "Email {email} to arrange offline payment",
    "billing.declarationNotice": "Confirm payment records only your declaration. Router does not verify settlement. A false declaration may cause the Provider to release this Client and block your account from that Provider.",
    "billing.confirmPayment": "Confirm payment",
    "billing.confirmTitle": "Confirm that payment is complete?",
    "billing.confirmDescription": "This is a self-declaration, not a payment verification. The Provider will be notified immediately and may independently check receipt.",
    "billing.yesPaid": "Yes, I paid",
    "billing.releaseTitle": "Release this Client now?",
    "billing.releaseDescription": "The Client tunnel will be disabled immediately. Router will erase the remote installation and return the Host to its Provider. Any data on the Client may be lost.",
    "billing.releaseNoRefundDescription": "Releasing hands the Host back to its Provider and permanently deletes this Client's data on it. Any period you have already paid for is NOT refunded, and the remaining time is forfeited. This cannot be undone.",
    "billing.releaseProgressTitle": "Releasing Client",
    "billing.releaseStarting": "Starting release…",
    "billing.releaseSucceeded": "Release completed. The Host has been returned to its Provider.",
    "billing.releaseFailedToast": "Release failed",
    "billing.releaseClient": "Release Client",
  ...
  "zh-CN": {
    ...
    "shareMarket.blockAndRevoke": "回收并拉黑",
    ...
    "shareMarket.declarePaid": "已完成付款",
    "shareMarket.goPay": "去付款",
    "shareMarket.paymentCountdown": "付款剩余 {countdown}",
    "shareMarket.paymentDetails": "收款信息",
    "shareMarket.paymentPreparing": "正在确认 Share 授权，账单生成后即可确认已付款。",
    "shareMarket.paymentDeadline": "请在 {time} 前声明付款",
    "shareMarket.trialEnds": "体验期至 {time}",
    "shareMarket.periodEnds": "已付费至 {time}",
    "shareMarket.confirmPaid": "我已按页面所示收款信息向 Share owner 完成付款。",
    "shareMarket.unblock": "解除拉黑",
    "shareMarket.blocks": "用户黑名单",
    "shareMarket.blocksHint": "被拉黑账号不能再租用你的 Share Market 拼车位，解除后可再次租用。",
    "shareMarket.noBlocks": "黑名单为空。",
    "shareMarket.blocksCol.email": "邮箱",
    "shareMarket.blocksCol.reason": "原因",
    "shareMarket.blocksCol.since": "时间",
    "shareMarket.blockedAddedToast": "已将 {email} 加入黑名单",
    "shareMarket.blockedAddedCountToast": "已将 {count} 个用户加入黑名单",
    "shareMarket.unblockedToast": "已将 {email} 移出黑名单",
    "market.userBlacklist": "用户黑名单",
    "market.blacklistUnblock": "解除拉黑",
    "market.blacklistCol.email": "邮箱",
    "market.blacklistCol.reason": "原因",
    "market.blacklistCol.since": "时间",
    "market.blacklistAddTitle": "添加黑名单用户",
    "market.blacklistAddHint": "可输入一个或多个账号邮箱，用逗号、空格或换行分隔。",
    "market.blacklistAddPlaceholder": "user@example.com",
    "market.blacklistAddCount": "将添加 {count} 个邮箱",
    "shareMarket.noPaymentMethods": "Share owner 当前没有可用收款信息，更新前请勿声明已付款。",
    "shareMarket.ownerRevokeReason": "由 Share owner 强制回收",
    "shareMarket.subscription.grantPending": "授权中",
    "shareMarket.subscription.activeFree": "免费使用中",
    "shareMarket.subscription.trialPaymentDue": "体验中 · 待付款",
    "shareMarket.subscription.activePaid": "已付款",
    "shareMarket.subscription.renewalDue": "待续费",
    ...
    "shareMarket.confirm.blockTitle": "回收并拉黑该用户？",
    "shareMarket.confirm.blockDescription": "将移除 {email} 的访问权限；解除拉黑前，该账号不能再租用你的挂售。",
    ...
    "shareMarket.error.billingPeriod": "账单周期必须是 1 到 365 之间的整数。",
    "shareMarket.error.currency": "币种仅支持 CNY 或 USD。",
    ...
    "shareMarket.dialog.amount": "价格",
    "shareMarket.dialog.currency": "币种",
    "shareMarket.dialog.billingCount": "每",
    "shareMarket.dialog.billingUnit": "单位",
    "shareMarket.dialog.day": "天",
    "shareMarket.dialog.week": "周",
    "shareMarket.dialog.month": "月",
    ...
    "account.clientHint": "以租户或 Host 供给方视角监控 Market 租用。付款、续费与释放仅在 Client Market 操作。",
    "account.shareHint": "以用户或供应商视角监控 Share Market 拼车位租用。租用、付款与回收仅在 Share Market 操作。",
    "account.client.tab.user": "User",
    "account.client.tab.provider": "Provider",
    ...
    "account.client.status.paymentDue": "待付款",
    ...
    "account.rentalsHint": "对你租用的 Client 付款、续费或归还 Host。",
    "account.paymentDetails": "收款信息",
    "account.visibilityHint": "收款方式和联系信息会在 Market 联系弹窗中向已登录用户展示，并在租户付款弹窗中展示。",
    "account.contact.title": "联系信息",
    "account.contact.hint": "会在付款弹窗与 Market 中展示，方便租户联系你。",
    ...
    "account.blockReason.paymentNotReceived": "未收到付款",
    ...
    "clientMarket.rentalPrice": "租赁价格",
    "clientMarket.rentalPeriod": "租赁周期（天）",
    "clientMarket.rentalCurrency": "币种",
    "clientMarket.priceUsd": "价格",
    "clientMarket.currency": "币种",
    "clientMarket.periodDays": "周期（天）",
    "clientMarket.free": "免费",
    "clientMarket.forever": "永久",
    "clientMarket.offerHint": "两项都留空表示免费永久；收费周期最短为 4 天。",
    "clientMarket.offerInvalid": "请同时填写有效的美元价格和租赁周期，或两项都留空表示免费永久。",
    "clientMarket.offerRange": "收费 Host 的价格范围为 $0.01-$1,000,000.00，租赁周期为 4-3650 天。",
    "clientMarket.offerUpdated": "Host 报价已更新",
    "clientMarket.editOffer": "修改 Host 报价",
    "clientMarket.editOfferAction": "修改报价",
    "clientMarket.editOfferHint": "修改会立即应用到未付款账单；已有付款周期的结束时间保持不变。Client owner 会收到邮件通知。",
    "clientMarket.makeFreeHint": "清空价格和周期可将 Host 改为免费永久。",
    ...
    "clientMarket.unpaidCleanup": "未付款 · 立即释放",
    "clientMarket.unpaidCleanupConfirmTitle": "释放这个未付款 Client？",
    "clientMarket.unpaidCleanupConfirmDesc": "移除 {host} 上的 Client。仅在确认未收到付款后使用。",
    "clientMarket.unpaidBlockCheckbox": "同时屏蔽该用户（{email}），禁止其再租用你的 Host",
    "clientMarket.blockedOwners": "用户黑名单",
    "clientMarket.blockedHint": "被屏蔽账号不能再分配你的 Host。可手动添加，或在「未付款 · 立即释放」时勾选屏蔽。",
    "clientMarket.blockEmailPlaceholder": "client@example.com",
    "clientMarket.blockAdd": "添加",
    "clientMarket.blockedAddedToast": "已屏蔽 {email}",
    "clientMarket.blockedAddedCountToast": "已屏蔽 {count} 个用户",
    "clientMarket.noneBlocked": "黑名单为空。",
    "clientMarket.blockedCol.email": "邮箱",
    "clientMarket.blockedCol.reason": "原因",
    "clientMarket.blockedCol.since": "时间",
    "clientMarket.blockReason.manual": "手动添加",
    ...
    "clientMarket.nextBillCountdown": "账单 {countdown}",
    "clientMarket.paymentDueCountdown": "截止 {countdown}",
    ...
    "clientMarket.importVersionRequired": "每行格式为 ip:port，可选 |备注|价格分|周期天|指纹。",
    ...
    "clientMarket.transferFormatHint": "每行一台：ip:port|备注|价格（分）|周期（天）|指纹。仅 ip:port 必填；以 # 开头的行为注释。",
    "clientMarket.importPlaceholder": "203.0.113.9:22\n203.0.113.10:22|机房备注|500|30",
    ...
    "createClient.routerOwner": "Router owner",
    "createClient.freeOnlyHint": "当前仅能从免费主机创建。免费 Host 可能不稳定或随时被收回；要稳定请到 Client Market 选付费 Host。",
    "createClient.freeOnlyHintLink": "Client Market",
    ...
    "billing.declaredToast": "付款声明已记录，并已通知 Host Provider。",
    "billing.releaseStartedToast": "Client 释放已开始，隧道已禁用。",
    "billing.paymentDue": "待付款",
    "billing.goPay": "去付款",
    "billing.billSoon": "账单 {countdown}",
    "billing.billSoonCompact": "账单 {countdown}",
    "billing.deadlineLabel": "付款截止 · {countdown}",
    "billing.deadlineCompact": "截止 {countdown}",
    "billing.paidThroughHint": "当前权益至 {date}",
    "billing.nextBillHint": "距下次账单 {countdown}",
    "billing.timeRemaining": "剩余时间",
    "billing.threeDays": "3 天",
    "billing.releaseNow": "立即释放",
    "billing.creationBlocked": "完成付款声明或释放此 Client 前，不能新建其他 Client。",
    "billing.releasing": "正在释放 Client，并将 Host 归还给 Provider...",
    "billing.releaseFailed": "释放失败——远端主机上可能仍有 cc-switch-server 在运行，请重试清理。",
    "billing.manageInMarket": "在 Market 管理",
    "billing.retryRelease": "重试释放",
    "billing.nextWindow": "距下次账单 {countdown}；当前权益至 {date}",
    "billing.payProvider": "向 Host Provider 付款",
    "billing.provider": "Provider",
    "billing.currentOffer": "当前报价",
    "billing.declareBefore": "声明截止时间",
    "billing.providerPaymentDetails": "Provider 收款信息",
    "billing.noPaymentDetails": "Provider 尚未配置在线收款信息。",
    "billing.emailOffline": "发送邮件至 {email} 协商线下付款",
    "billing.declarationNotice": "确认付款只记录你的声明，Router 不验证到账。虚假声明可能导致 Provider 释放此 Client，并禁止你的账号继续使用该 Provider。",
    "billing.confirmPayment": "确认已付款",
    "billing.confirmTitle": "确认已经完成付款？",
    "billing.confirmDescription": "这是用户自主声明，不是到账验证。Provider 会立即收到通知，并可自行核对收款。",
    "billing.yesPaid": "确认，我已付款",
    "billing.releaseTitle": "立即释放此 Client？",
    "billing.releaseDescription": "Client 隧道会立即禁用，Router 将清除远程安装并把 Host 归还给 Provider。Client 上的数据可能永久丢失。",
    "billing.releaseNoRefundDescription": "释放会把主机交还给供给方,并永久删除该 Client 在主机上的数据。已支付的周期不会退款,剩余时间作废。此操作不可撤销。",
    "billing.releaseProgressTitle": "正在释放 Client",
    "billing.releaseStarting": "正在发起释放…",
    "billing.releaseSucceeded": "释放完成,主机已交还供给方。",
    "billing.releaseFailedToast": "释放失败",
    "billing.releaseClient": "释放 Client",
