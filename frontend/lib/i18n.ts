...
export const messages = {
  en: {
    ...
    "account.visibilityHint": "Shown only to users renting one of your Hosts. Public Market rows expose method icons only.",
  ...
  "zh-CN": {
    ...
    "account.visibilityHint": "仅向正在租用你 Host 的用户展示；公开 Market 行只显示付款方式图标。",
