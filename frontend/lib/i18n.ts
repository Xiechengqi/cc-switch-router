...
export const messages = {
  en: {
    ...
    "settings.mapDescription": "Control dashboard map overlays and viewport framing. Preferences are saved in this browser.",
    ...
    "settings.mapViewportDescription": "Tune which slice of the 2:1 world map is visible in the dashboard card.",
    ...
    "settings.mapVisibleEndPx": "Visible end (px)",
    "settings.mapVisibleEndPxDescription": "Map content Y at the bottom edge when the map is tall enough.",
    "settings.mapVerticalPanPx": "Vertical pan (px)",
    "settings.mapVerticalPanPxDescription": "Extra downward offset applied after framing.",
  ...
  "zh-CN": {
    ...
    "settings.mapDescription": "控制 Dashboard 地图叠加层与视口范围。偏好设置保存在当前浏览器。",
    ...
    "settings.mapViewportDescription": "调整 Dashboard 地图卡片中可见的世界地图切片。",
    "settings.mapVisibleStartPx": "可见起点 (px)",
    "settings.mapVisibleStartPxDescription": "视口顶边对应的地图内容 Y 坐标。",
    "settings.mapVisibleEndPx": "可见终点 (px)",
    "settings.mapVisibleEndPxDescription": "地图足够高时，视口底边对应的地图内容 Y 坐标。",
    "settings.mapVerticalPanPx": "垂直平移 (px)",
    "settings.mapVerticalPanPxDescription": "在视口范围计算后额外向下平移的像素数。",
