...
export const messages = {
  en: {
    ...
    "account.blockedOwners": "Blocked Client owners",
    "account.blockedHint": "Created only when you release a Client as unpaid. Blocks that account from your Hosts; restore access here.",
    "account.blockedExpand": "Show",
    "account.blockedCollapse": "Hide",
    "account.unblock": "Unblock",
    "account.noneBlocked": "No Client owners are blocked from your Hosts.",
    ...
    "clientMarket.unpaidCleanup": "Not paid · release and block",
    "clientMarket.unpaidCleanupConfirmTitle": "Release this unpaid Client?",
    "clientMarket.unpaidCleanupConfirmDesc": "Remove the Client on {host} and block this renter from allocating your Hosts again. Use this only after checking that payment was not received.",
    ...
    "clientMarket.cleanupFailedGuidance.remote": "Remote stop/wipe failed. Retry cleanup, or clean the host manually then Reverify.",
    ...
    "clientMarket.scopeMineEmpty": "You have not registered any hosts yet.",
    ...
    "clientMarket.rentals.count": "{count} active",
    ...
    "billing.releaseFailed": "Client release failed. Retry the cleanup.",
  ...
  "zh-CN": {
    ...
    "account.blockedOwners": "已屏蔽的 Client owner",
    "account.blockedHint": "仅在你以「未付款」释放 Client 时产生；会禁止该账号再租用你的 Host，可在此恢复。",
    "account.blockedExpand": "展开",
    "account.blockedCollapse": "收起",
    "account.unblock": "解除屏蔽",
    "account.noneBlocked": "当前没有被禁止使用你 Host 的 Client owner。",
    ...
    "clientMarket.unpaidCleanup": "未付款 · 释放并屏蔽",
    "clientMarket.unpaidCleanupConfirmTitle": "释放这个未付款 Client？",
    "clientMarket.unpaidCleanupConfirmDesc": "移除 {host} 上的 Client，并禁止该租户再次分配你的 Host。仅在确认未收到付款后使用。",
    ...
    "clientMarket.cleanupFailedGuidance.remote": "远程停止/删除失败。可重试清理，或手动清理后重新验证。",
    ...
    "billing.releaseFailed": "Client 释放失败，请重试清理。",
