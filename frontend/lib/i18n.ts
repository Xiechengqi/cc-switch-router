...
export const messages = {
  en: {
    ...
    "createClient.officialUnavailable": "The official Provider has no idle Host capacity right now. Check another Provider below only if you trust it.",
    "createClient.officialNotConfigured": "No official Provider is configured on this Router yet. Select a Provider below only if you trust it.",
    "createClient.officialNoCapacityButton": "Official Provider has no capacity",
  ...
  "zh-CN": {
    ...
    "createClient.routerOwner": "Router owner",
    "createClient.officialUnavailable": "官方 Provider 当前没有空闲 Host。只有在你明确信任其他 Provider 时，再在下方勾选。",
    "createClient.officialNotConfigured": "此 Router 尚未配置官方 Provider。只有在你明确信任时，再在下方勾选其他 Provider。",
    "createClient.officialNoCapacityButton": "官方 Provider 暂无容量",
