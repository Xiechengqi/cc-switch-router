...
import { Activity, ChevronDown, FileClock, KeyRound, LogOut, Monitor, Network, Settings, Share2, Store, UserRound } from "lucide-react";
...
function DashboardNav({
  ...
  const items = [
    ...
    { id: "logs" as const, href: DASHBOARD_LOGS_PATH, icon: FileClock, label: t("nav.logsTab") },
    ...(authed
