...
export function PresenceFooter() {
  ...
  return (
    <footer className="mx-auto mt-auto flex w-[calc(100%-2rem)] max-w-7xl shrink-0 flex-wrap items-center justify-center gap-2 py-6 font-mono text-[11px] uppercase tracking-[0.1em] text-muted-foreground">
      ...
      {presence?.telegramUrl ? (
        <>
          <span className="opacity-50">|</span>
          <a href={presence.telegramUrl} target="_blank" rel="noopener noreferrer" className="hover:text-primary">
            Telegram
          </a>
        </>
      ) : null}
