...
pub struct RouterMetricsStatus {
    ...
    pub ssh_pending_channel_opens: u64,
    pub ssh_channel_open_started_total: u64,
    pub ssh_channel_open_succeeded_total: u64,
    pub ssh_channel_open_explicit_failures_total: u64,
    pub ssh_channel_open_timeout_total: u64,
    pub ssh_channel_open_session_errors_total: u64,
    pub ssh_channel_open_cancelled_total: u64,
    pub ssh_active_bridges: u64,
    pub ssh_bridge_created_total: u64,
    pub ssh_bridge_completed_total: u64,
    pub ssh_bridge_cancelled_total: u64,
    pub ssh_bridge_write_stall_total: u64,
    pub ssh_bridge_half_close_idle_total: u64,
    pub ssh_bridge_io_errors_total: u64,
    pub ssh_forward_capacity_rejected_total: u64,
    pub proxy_inflight: u64,
    pub proxy_requests_total: u64,
    pub proxy_upstream_errors_total: u64,
    pub proxy_5xx_total: u64,
    pub share_active_requests: u64,
    pub share_oldest_inflight_age_secs: u64,
    pub share_oldest_progress_age_secs: u64,
    pub share_request_watchdog_forced_release_total: u64,
    pub share_request_manual_release_total: u64,
    pub proxy_request_body_timeout_total: u64,
    pub proxy_response_header_timeout_total: u64,
    pub proxy_downstream_stall_timeout_total: u64,
    pub proxy_request_hard_timeout_total: u64,
    pub proxy_stream_semantic_terminal_total: u64,
    pub proxy_stream_first_event_timeout_total: u64,
    pub proxy_stream_idle_timeout_total: u64,
    pub proxy_stream_parser_overflow_total: u64,
    pub proxy_stream_upstream_errors_total: u64,
