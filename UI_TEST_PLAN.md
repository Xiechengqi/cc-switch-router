...
| SM-05 | 添加付费拼车位 | 输入三位以上小数、经 API 提交非 USD 币种,或未配置 USD 收款资料/付款宽限 | UI 固定使用 USD；非法报价被前后端阻止 |
...
| SM-20 | 在线且已获准入的可用座位 | 点租用 | 先出现确认框，明确 Owner、Share/座位、在线状态、免费期限或 USD 日费；未确认前不提交租用请求 |
